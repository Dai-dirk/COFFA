...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Evaluate MobileNetV3-Large checkpoint on ImageNet validation set."
    )
    parser.add_argument(
        "--checkpoint",
        required=False,
        default="/home/gbzou/ISCA_AE/Software/DNN/MobileNetV3/450_act3_mobilenetv3_large.pth",
        help="Path to the checkpoint file, e.g. 450_act3_mobilenetv3_large.pth",
    )
    parser.add_argument(
        "--data-dir",
        required=False,
...
if __name__ == "__main__":
    main()
# python mobilenetv3/evaluate_checkpoint.py   --checkpoint mobilenetv3/450_act3_mobilenetv3_large.pth   --data-dir EfficientNet/ILSVRC2012_img_val   --batch-size 128   --workers 8
