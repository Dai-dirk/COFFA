...
DEFAULT_OUTPUT_DIR = Path("/capsule/home/huangdaiwei/test_zgb/model/mistral_7b_instruct_exp16_swish16_taylor")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Export Mistral 7B Instruct with Swish/Exp Taylor lookup activations.")
    parser.add_argument(
        "--output-dir",
        type=Path,
    ...
    parser.add_argument(
        ...
        help="Base model identifier or local path. Defaults to the cached Mistral-7B-Instruct snapshot.",
    )
    parser.add_argument(
        "--device",
        type=str,
