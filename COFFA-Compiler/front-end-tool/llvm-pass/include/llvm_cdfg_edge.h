...
public:
    ...
    void setIterDist(int minIterDist){_hasIterDist = true; _minIterDist = minIterDist;}
    bool hasIterDist(){return _hasIterDist;}
    int getIterDist(){return _minIterDist;}
};
