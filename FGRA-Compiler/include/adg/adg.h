...
public:
    ...
    //@hw_yuan: get/set the number of MIMD-GPE
    int numMIMDGpeNodes(){ return _numMIMDGpeNodes; }
    void setNumMIMDGpeNodes(int numMIMDGpeNodes){ _numMIMDGpeNodes = numMIMDGpeNodes; }
    ...
    void setmaxLUTinput(int maxLUTinput){ _maxLUTinput = maxLUTinput; }
    ...
    void setIobIdxToId(int idx, int id){ _iobIdxToIds[idx] = id; }
    int getIobIdFromIdx(int idx){ return _iobIdxToIds[idx]; }
    ...
    const std::map<int, std::vector<int>>& spadBankToIobs(){ return _spadBankToIobs; }
    const std::vector<int>& spadBankToIobs(int bank){ return _spadBankToIobs[bank]; }
    void setSpadBankToIobs(int bank, std::vector<int> iobs){ _spadBankToIobs[bank] = iobs; }
    std::vector<int> getIobGrp(int iobIdx){ return _spadBankToIobs[_iobToSpadBanks[iobIdx][0]];} // assert: IOB and Spad banks are set-associate
