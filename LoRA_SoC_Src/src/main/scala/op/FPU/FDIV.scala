...
//   val isSqrt = RegNext(io.specialIO.isSqrt)
//   val in_valid = RegNext(io.specialIO.in_valid)
//   val out_ready = RegNext(io.specialIO.out_ready)
//   val out_valid = io.specialIO.out_valid
//   val in_ready = io.specialIO.in_ready
...
//   io.result := RegNext(Cat(combinedSignReg, combinedExpReg, combinedSigReg))
// //  io.fflags := RegNext(combinedFFlagsReg)
// }
...
// }
// object VerilogFDIVGen extends App {
//   (new chisel3.stage.ChiselStage).emitVerilog(new FDIV(6, 10), args)
// }
