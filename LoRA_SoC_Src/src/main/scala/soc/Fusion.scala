...
object FusionParam {
  ...
  val fusion_spec_filename = rootDirPath + "/generators/fusion_mem_fp/fgra-mg/src/main/resources/fusion_spec.json"
  val operation_set_filename = rootDirPath + "/generators/fusion_mem_fp/fgra-mg/src/main/resources/operations.json"
  val fgra_adg_filename = rootDirPath + "/generators/fusion_mem_fp/fgra-mg/src/main/resources/fgra_adg.json"
}

class FusionMemFP(opcodes: OpcodeSet)(implicit p: Parameters) extends LazyRoCC(opcodes, nPTWPorts = 1) {
...
class FusionModuleImp(outer: FusionMemFP)(implicit p: Parameters) extends LazyRoCCModuleImp(outer)
