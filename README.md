...
All folders contain README files with introductions; the detailed instructions for running COFFA can be found in the COFFA manual [Demo](https://github.com/Dai-dirk/COFFA/blob/main/COFFA-Manual-1.0.pdf).
