...
; Function Attrs: noinline nosync nounwind optnone readonly speculatable willreturn uwtable
...
for.cond.cleanup:                                 ; preds = %for.body
  ...
  store float %add.lcssa, ptr @sum_arr, align 4, !tbaa !6
  ret void
...
attributes #0 = { noinline nosync nounwind optnone readonly speculatable willreturn uwtable "__CGRA_Hardware_Op"="myExp" "frame-pointer"="none" "min-legal-vector-width"="0" "no-trapping-math"="true" "size"="___CGRA_HARDWARE_OP__myExp___" "stack-protector-buffer-size"="8" "target-cpu"="i686" "target-features"="+cx8,+x87" "tune-cpu"="generic" }
