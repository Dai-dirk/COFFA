...
attributes #0 = { noinline nosync nounwind optnone readonly speculatable willreturn uwtable "__CGRA_Hardware_Op"="myExp" "frame-pointer"="none" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="i686" "target-features"="+cx8,+x87" "tune-cpu"="generic" }
