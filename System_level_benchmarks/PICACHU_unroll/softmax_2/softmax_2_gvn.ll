...
for.cond.cleanup:                                 ; preds = %for.body
  ...
  store float %add.1.lcssa, float* getelementptr inbounds ([1 x float], [1 x float]* @summ, i32 0, i32 0), align 4, !tbaa !3
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %1 = load float, float* getelementptr inbounds ([1 x float], [1 x float]* @maxx, i32 0, i32 0), align 4, !tbaa !3
  %sub = fsub float %0, %1
  ...
  %3 = load float, float* %arrayidx.1, align 4, !tbaa !3
  %4 = load float, float* getelementptr inbounds ([1 x float], [1 x float]* @maxx, i32 0, i32 0), align 4, !tbaa !3
  %sub.1 = fsub float %3, %4
  ...
  %5 = bitcast i32 %shl.i.1 to float
  ...
  %mul14.i.1 = fmul float %add13.i.1, %5
