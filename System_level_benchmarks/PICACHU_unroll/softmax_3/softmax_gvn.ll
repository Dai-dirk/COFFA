...
entry:
  %call = tail call i32 @loop_begin() #2
  %0 = load float, ptr @sum_arr, align 4, !tbaa !6
  br label %for.body

for.cond.cleanup:                                 ; preds = %for.body
  %call2 = tail call i32 @loop_end() #2
  ret void

for.body:                                         ; preds = %for.body, %entry
  %i.06 = phi i32 [ 0, %entry ], [ %inc, %for.body ]
  %arrayidx = getelementptr inbounds [2048 x float], ptr @input, i32 0, i32 %i.06
  %1 = load float, ptr %arrayidx, align 4, !tbaa !6
  %div = fdiv float %1, %0
  %arrayidx1 = getelementptr inbounds [2048 x float], ptr @output, i32 0, i32 %i.06
  store float %div, ptr %arrayidx1, align 4, !tbaa !6
