...
module DivSqrtRawFN_small(
  ...
  wire        skipCycle2 = cycleNum == 5'h3 & sigX_Z[25];	// @[DivSqrtRecFN_small.scala:223:33, :244:29, :300:{31,39,48}]
  ...
  wire [10:0] sExpQuot_S_div = {io_a_sExp[9], io_a_sExp} + {{3{io_b_sExp[8]}}, ~(io_b_sExp[7:0])};	// @[DivSqrtRecFN_small.scala:279:21, :280:{28,40,52}]
  wire        _fractB_Z_T_10 = inReady & io_sqrtOp;	// @[DivSqrtRecFN_small.scala:224:33, :342:25]
  wire [22:0] _fractB_Z_T_25 = inReady ? 23'h0 : fractB_Z[23:1];	// @[DivSqrtRecFN_small.scala:224:33, :235:29, :342:16, :345:{16,71}]
  wire [31:0] _bitMask_T = 32'h1 << cycleNum;	// @[DivSqrtRecFN_small.scala:223:33, :359:23]
  ...
  wire [26:0] rem = {1'h0, inReady & ~oddSqrt_S ? {io_a_sig, 1'h0} : 26'h0} | (_sigX_Z_T_7 ? {io_a_sig[23:22] - 2'h1, io_a_sig[21:0], 3'h0} : 27'h0) | (inReady ? 27'h0 : {rem_Z, 1'h0});	// @[Cat.scala:33:92, DivSqrtRecFN_small.scala:224:33, :225:33, :242:29, :291:32, :300:31, :351:{12,21,24,47,57}, :352:{12,21}, :353:{27,56}, :354:27, :357:11, :358:{12,29}]
  wire [28:0] trialRem = {2'h0, rem} - {2'h0, {1'h0, (inReady & ~io_sqrtOp ? {io_b_sig, 1'h0} : 26'h0) | (_sigX_Z_T_7 ? 26'h2800000 : 26'h0) | {1'h0, inReady & io_sqrtOp & ~(io_a_sExp[0]) | ~inReady & ~sqrtOp_Z, inReady ? 24'h0 : fractB_Z}} | (~inReady & sqrtOp_Z ? {sigX_Z, 1'h0} : 27'h0)};	// @[DivSqrtRecFN_small.scala:224:33, :225:33, :227:29, :235:29, :244:29, :270:33, :290:{35,48}, :339:23, :341:16, :351:12, :352:{12,21}, :353:56, :357:11, :361:{12,21,48}, :362:21, :363:12, :364:{12,74}, :365:{23,26,74}, :366:{12,23,44}, :367:29]
  wire        newBit = $signed(trialRem) > -29'sh1;	// @[DivSqrtRecFN_small.scala:367:29, :368:23]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      cycleNum <= (entering & normalCase_S ? (io_sqrtOp ? {4'hC, ~(io_a_sExp[0])} : 5'h1A) : 5'h0) | (entering | skipCycle2 ? 5'h0 : cycleNum - 5'h1) | {4'h0, entering & ~normalCase_S | skipCycle2};	// @[DivSqrtRecFN_small.scala:223:33, :276:27, :290:48, :296:28, :297:40, :300:39, :304:{26,28}, :305:16, :306:20, :307:24, :312:{16,56,95}, :316:38]
      inReady <= entering & ~normalCase_S | ~entering & ~skipCycle2 & cycleNum - 5'h1 < 5'h2 | skipCycle2;	// @[DivSqrtRecFN_small.scala:223:33, :224:33, :276:27, :296:28, :300:39, :304:{26,28}, :312:{16,17,31,56,95}, :316:38]
      rawOutValid <= entering & ~normalCase_S | ~entering & ~skipCycle2 & cycleNum - 5'h1 == 5'h1 | skipCycle2;	// @[DivSqrtRecFN_small.scala:223:33, :225:33, :276:27, :296:28, :300:39, :304:{26,28}, :312:{16,17,31,56,95}, :316:38, :317:42]
    end
    if (entering) begin	// @[DivSqrtRecFN_small.scala:296:28]
      sqrtOp_Z <= io_sqrtOp;	// @[DivSqrtRecFN_small.scala:227:29]
      if (io_sqrtOp) begin
        majorExc_Z <= io_a_isNaN & ~(io_a_sig[22]) | notSigNaNIn_invalidExc_S_sqrt;	// @[DivSqrtRecFN_small.scala:228:29, :255:43, :258:38, common.scala:82:{46,49,56}]
        isNaN_Z <= io_a_isNaN | notSigNaNIn_invalidExc_S_sqrt;	// @[DivSqrtRecFN_small.scala:230:29, :255:43, :265:26]
        sExp_Z <= {io_a_sExp[9], io_a_sExp[9:1]} + 10'h80;	// @[DivSqrtRecFN_small.scala:234:29, :279:21, :334:{29,34}]
      end
      else begin
        majorExc_Z <= io_a_isNaN & ~(io_a_sig[22]) | io_b_isNaN & ~(io_b_sig[22]) | notSigNaNIn_invalidExc_S_div | ~io_a_isNaN & ~io_a_isInf & io_b_isZero;	// @[DivSqrtRecFN_small.scala:228:29, :253:42, :255:9, :260:46, :261:{36,51}, common.scala:82:{46,49,56}]
        isNaN_Z <= io_a_isNaN | io_b_isNaN | notSigNaNIn_invalidExc_S_div;	// @[DivSqrtRecFN_small.scala:230:29, :253:42, :266:42]
        sExp_Z <= {$signed(sExpQuot_S_div) > 11'sh1BF ? 4'h6 : sExpQuot_S_div[9:6], sExpQuot_S_div[5:0]};	// @[Cat.scala:33:92, DivSqrtRecFN_small.scala:234:29, :279:21, :283:{16,48}, :285:31, :287:27]
      end
    ...
    if (entering | ~inReady & sqrtOp_Z)	// @[DivSqrtRecFN_small.scala:224:33, :227:29, :296:28, :339:{20,23,33}]
      fractB_Z <= (inReady & ~io_sqrtOp ? {io_b_sig[22:0], 1'h0} : 24'h0) | {_fractB_Z_T_10 & ~(io_a_sExp[0]), _fractB_Z_T_10 & io_a_sExp[0] | _fractB_Z_T_25[22], _fractB_Z_T_25[21:0]};	// @[DivSqrtRecFN_small.scala:224:33, :225:33, :235:29, :270:33, :290:48, :341:{16,25,73,90}, :342:{25,38}, :343:{38,41}, :344:100, :345:16]
    if (_T_6) begin	// @[DivSqrtRecFN_small.scala:389:20]
      rem_Z <= newBit ? trialRem[25:0] : rem[25:0];	// @[DivSqrtRecFN_small.scala:242:29, :357:11, :367:29, :368:23, :370:24]
      sigX_Z <= (inReady & ~io_sqrtOp ? {newBit, 25'h0} : 26'h0) | {1'h0, inReady & io_sqrtOp, _sigX_Z_T_7 ? {newBit, 23'h0} : 24'h0} | (inReady ? 26'h0 : sigX_Z) | (~inReady & newBit ? _bitMask_T[27:2] : 26'h0);	// @[DivSqrtRecFN_small.scala:224:33, :225:33, :244:29, :270:33, :339:23, :341:16, :342:16, :351:12, :352:21, :359:{23,34}, :362:12, :368:23, :393:{16,25,50}, :394:{25,74}, :395:{16,50}, :396:{16,74}, :397:{16,27}]
    end
