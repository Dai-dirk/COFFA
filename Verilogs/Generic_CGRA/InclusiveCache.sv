...
module InclusiveCache(
  ...
  wire             _inclusive_cache_bank_sched_io_in_a_ready;	// @[InclusiveCache.scala:186:29]
  wire             _inclusive_cache_bank_sched_io_in_b_valid;	// @[InclusiveCache.scala:186:29]
  wire [1:0]       _inclusive_cache_bank_sched_io_in_b_bits_param;	// @[InclusiveCache.scala:186:29]
  wire [31:0]      _inclusive_cache_bank_sched_io_in_b_bits_address;	// @[InclusiveCache.scala:186:29]
  wire             _inclusive_cache_bank_sched_io_in_c_ready;	// @[InclusiveCache.scala:186:29]
  wire             _inclusive_cache_bank_sched_io_in_d_valid;	// @[InclusiveCache.scala:186:29]
  wire [2:0]       _inclusive_cache_bank_sched_io_in_d_bits_opcode;	// @[InclusiveCache.scala:186:29]
  wire [1:0]       _inclusive_cache_bank_sched_io_in_d_bits_param;	// @[InclusiveCache.scala:186:29]
  wire [2:0]       _inclusive_cache_bank_sched_io_in_d_bits_size;	// @[InclusiveCache.scala:186:29]
  wire [5:0]       _inclusive_cache_bank_sched_io_in_d_bits_source;	// @[InclusiveCache.scala:186:29]
  wire [3:0]       _inclusive_cache_bank_sched_io_in_d_bits_sink;	// @[InclusiveCache.scala:186:29]
  wire             _inclusive_cache_bank_sched_io_in_d_bits_denied;	// @[InclusiveCache.scala:186:29]
  wire             _inclusive_cache_bank_sched_io_in_d_bits_corrupt;	// @[InclusiveCache.scala:186:29]
  ...
  wire [3:0][63:0] _GEN_0 = '{64'h0, 64'h0, 64'h0, 64'h6080801};	// @[MuxLiteral.scala:49:10]
  ...
  wire             in_ready = _out_back_io_enq_ready & out_iready;	// @[Decoupled.scala:375:21, RegisterRouter.scala:83:24]
  wire             out_valid = _out_back_io_deq_valid & out_oready;	// @[Decoupled.scala:375:21, RegisterRouter.scala:83:24]
  wire [3:0]       _GEN_7 = {{~(|_GEN_2)}, {~(|_GEN_2)}, {1'h1}, {~(|_GEN_2)}};	// @[MuxLiteral.scala:49:10, RegisterRouter.scala:83:24]
  wire [2:0]       bundleIn_0_1_d_bits_opcode = {2'h0, _out_back_io_deq_bits_read};	// @[Decoupled.scala:375:21, OneHot.scala:57:35, RegisterRouter.scala:98:19]
  wire             flushSelect = flushInAddress[63:28] == 36'h8;	// @[InclusiveCache.scala:129:29, Parameters.scala:137:{31,65}]
  assign _GEN = ~flushSelect;	// @[InclusiveCache.scala:130:34, :194:{26,41}, Parameters.scala:137:65]
  `ifndef SYNTHESIS	// @[InclusiveCache.scala:198:14]
  ...
  wire [31:0]      bundleIn_0_b_bits_address = _inclusive_cache_bank_sched_io_in_b_bits_address | 32'h80000000;	// @[InclusiveCache.scala:186:29, Parameters.scala:137:31, :247:14]
  ...
  TLMonitor_40 monitor (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
    .io_in_a_ready        (_inclusive_cache_bank_sched_io_in_a_ready),	// @[InclusiveCache.scala:186:29]
    ...
    .io_in_b_valid        (_inclusive_cache_bank_sched_io_in_b_valid),	// @[InclusiveCache.scala:186:29]
    .io_in_b_bits_param   (_inclusive_cache_bank_sched_io_in_b_bits_param),	// @[InclusiveCache.scala:186:29]
    .io_in_b_bits_address (bundleIn_0_b_bits_address),	// @[Parameters.scala:247:14]
    .io_in_c_ready        (_inclusive_cache_bank_sched_io_in_c_ready),	// @[InclusiveCache.scala:186:29]
    ...
    .io_in_d_valid        (_inclusive_cache_bank_sched_io_in_d_valid),	// @[InclusiveCache.scala:186:29]
    .io_in_d_bits_opcode  (_inclusive_cache_bank_sched_io_in_d_bits_opcode),	// @[InclusiveCache.scala:186:29]
    .io_in_d_bits_param   (_inclusive_cache_bank_sched_io_in_d_bits_param),	// @[InclusiveCache.scala:186:29]
    .io_in_d_bits_size    (_inclusive_cache_bank_sched_io_in_d_bits_size),	// @[InclusiveCache.scala:186:29]
    .io_in_d_bits_source  (_inclusive_cache_bank_sched_io_in_d_bits_source),	// @[InclusiveCache.scala:186:29]
    .io_in_d_bits_sink    (_inclusive_cache_bank_sched_io_in_d_bits_sink),	// @[InclusiveCache.scala:186:29]
    .io_in_d_bits_denied  (_inclusive_cache_bank_sched_io_in_d_bits_denied),	// @[InclusiveCache.scala:186:29]
    .io_in_d_bits_corrupt (_inclusive_cache_bank_sched_io_in_d_bits_corrupt),	// @[InclusiveCache.scala:186:29]
  ...
  TLMonitor_41 monitor_1 (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
    .io_in_a_ready        (in_ready),	// @[RegisterRouter.scala:83:24]
    ...
    .io_in_d_bits_opcode  (bundleIn_0_1_d_bits_opcode),	// @[RegisterRouter.scala:98:19]
  ...
  Queue_51 out_back (	// @[Decoupled.scala:375:21]
    .clock                               (clock),
    .reset                               (reset),
  ...
  assign auto_ctl_in_a_ready = in_ready;	// @[RegisterRouter.scala:83:24]
  assign auto_ctl_in_d_valid = out_valid;	// @[RegisterRouter.scala:83:24]
  assign auto_ctl_in_d_bits_opcode = bundleIn_0_1_d_bits_opcode;	// @[RegisterRouter.scala:98:19]
  ...
  assign auto_in_a_ready = _inclusive_cache_bank_sched_io_in_a_ready;	// @[InclusiveCache.scala:186:29]
  assign auto_in_b_valid = _inclusive_cache_bank_sched_io_in_b_valid;	// @[InclusiveCache.scala:186:29]
  assign auto_in_b_bits_param = _inclusive_cache_bank_sched_io_in_b_bits_param;	// @[InclusiveCache.scala:186:29]
  assign auto_in_b_bits_address = bundleIn_0_b_bits_address;	// @[Parameters.scala:247:14]
  assign auto_in_c_ready = _inclusive_cache_bank_sched_io_in_c_ready;	// @[InclusiveCache.scala:186:29]
  assign auto_in_d_valid = _inclusive_cache_bank_sched_io_in_d_valid;	// @[InclusiveCache.scala:186:29]
  assign auto_in_d_bits_opcode = _inclusive_cache_bank_sched_io_in_d_bits_opcode;	// @[InclusiveCache.scala:186:29]
  assign auto_in_d_bits_param = _inclusive_cache_bank_sched_io_in_d_bits_param;	// @[InclusiveCache.scala:186:29]
  assign auto_in_d_bits_size = _inclusive_cache_bank_sched_io_in_d_bits_size;	// @[InclusiveCache.scala:186:29]
  assign auto_in_d_bits_source = _inclusive_cache_bank_sched_io_in_d_bits_source;	// @[InclusiveCache.scala:186:29]
  assign auto_in_d_bits_sink = _inclusive_cache_bank_sched_io_in_d_bits_sink;	// @[InclusiveCache.scala:186:29]
  assign auto_in_d_bits_denied = _inclusive_cache_bank_sched_io_in_d_bits_denied;	// @[InclusiveCache.scala:186:29]
  assign auto_in_d_bits_corrupt = _inclusive_cache_bank_sched_io_in_d_bits_corrupt;	// @[InclusiveCache.scala:186:29]
