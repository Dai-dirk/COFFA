...
module IntToFP_prenorm(
  ...
  wire [126:0] _in_shift_s1_T = {63'h0, in_abs} << (io_in_int[31] ? _neg_lzc_clz_io_out : _pos_lzc_clz_io_out);	// @[CLZ.scala:21:21, IntToFP.scala:32:55, :35:19, :44:16, :49:41, :55:29]
  ...
  assign io_out_norm_int =
    ...
    & (in_abs
      ...
      ? {_in_shift_s1_T[61:0], 1'h0}
      : _in_shift_s1_T[62:0];	// @[Bitwise.scala:77:12, Cat.scala:33:92, IntToFP.scala:32:55, :35:{19,46}, :37:19, :48:28, :49:{29,41}, :50:{28,32,35,44,56}, :53:{22,41,53}, :55:{29,36}, :56:{20,52}]
