...
module ListBuffer(
  ...
  wire [144:0] _data_ext_R0_data;	// @[ListBuffer.scala:51:18]
  ...
  assign io_data_mask = _data_ext_R0_data[143:128];	// @[ListBuffer.scala:51:18]
  assign io_data_corrupt = _data_ext_R0_data[144];	// @[ListBuffer.scala:51:18]
endmodule
