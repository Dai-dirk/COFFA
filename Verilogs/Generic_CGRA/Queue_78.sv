...
module Queue_78(
  ...
  wire [152:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_36 ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({1'h0, io_enq_bits_id, io_enq_bits_mask, io_enq_bits_data}),	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_mask = _ram_ext_R0_data[143:128];	// @[Decoupled.scala:273:95]
endmodule
