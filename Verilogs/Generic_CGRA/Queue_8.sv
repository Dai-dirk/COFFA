...
module Queue_8(
  ...
  wire [120:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_address = _ram_ext_R0_data[47:17];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[55:48];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[119:56];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[120];	// @[Decoupled.scala:273:95]
endmodule
