...
module Queue_82(
  ...
  wire [189:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_41 ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({1'h0, io_enq_bits_data, io_enq_bits_mask, io_enq_bits_address, io_enq_bits_source, io_enq_bits_size, 3'h0, io_enq_bits_opcode}),	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[12:10];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_address = _ram_ext_R0_data[44:13];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[60:45];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[188:61];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[189];	// @[Decoupled.scala:273:95]
endmodule
