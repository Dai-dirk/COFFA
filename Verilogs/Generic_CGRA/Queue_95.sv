...
module Queue_95(
  ...
  wire [79:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_14 ram_ext (	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_sink = _ram_ext_R0_data[13:10];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_denied = _ram_ext_R0_data[14];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[78:15];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[79];	// @[Decoupled.scala:273:95]
endmodule
