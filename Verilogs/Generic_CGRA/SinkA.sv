...
module SinkA(
  ...
  assign io_req_bits_tag = io_a_bits_address[27:14];	// @[Cat.scala:33:92, Parameters.scala:214:22, :215:19]
  ...
  assign io_req_bits_set = io_a_bits_address[13:6];	// @[Cat.scala:33:92, Parameters.scala:214:22, :216:28]
