...
module SourceC(
  ...
  reg  [13:0] req_r_tag;	// @[Reg.scala:19:16]
  reg  [7:0]  req_r_set;	// @[Reg.scala:19:16]
  reg  [2:0]  req_r_way;	// @[Reg.scala:19:16]
  wire [7:0]  req_set = busy ? req_r_set : io_req_bits_set;	// @[Reg.scala:19:16, SourceC.scala:66:21, :69:17]
  ...
  reg  [13:0] s2_req_tag;	// @[Reg.scala:19:16]
  ...
  reg  [13:0] s3_req_tag;	// @[Reg.scala:19:16]
  reg  [7:0]  s3_req_set;	// @[Reg.scala:19:16]
  `ifndef SYNTHESIS	// @[SourceC.scala:64:10]
  ...
  Queue_53 queue (	// @[SourceC.scala:54:21]
    .clock               (clock),
    .reset               (reset),
    ...
    .io_enq_bits_address ({4'h0, s3_req_tag, s3_req_set, 6'h0}),	// @[Cat.scala:33:92, Parameters.scala:220:15, Reg.scala:19:16, SourceC.scala:58:21]
