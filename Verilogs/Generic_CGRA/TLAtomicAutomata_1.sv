...
module TLAtomicAutomata_1(
  ...
  wire            a_isSupported = auto_in_a_bits_opcode == 3'h3 ? _a_canArithmetic_T_3 & (_GEN == 7'h0 | _GEN_0 == 7'h0 | _GEN_2 == 7'h0) : auto_in_a_bits_opcode != 3'h2 | _a_canArithmetic_T_3 & (_GEN == 7'h0 | _GEN_0 == 7'h0 | _GEN_2 == 7'h0);	// @[AtomicAutomata.scala:92:47, :93:47, :94:{32,63}, Bundles.scala:259:74, Mux.scala:81:61, Parameters.scala:92:42, :137:{45,65}, :671:54, :672:42]
  ...
  wire            idle = beatsLeft == 9'h0;	// @[Arbiter.scala:88:30, :89:28, Edges.scala:229:27]
  ...
  wire            _GEN_11 = out_1_ready & out_1_earlyValid & ~a_isSupported & cam_free_0;	// @[Arbiter.scala:124:31, AtomicAutomata.scala:79:24, :82:44, :94:32, :153:38, :155:15, :176:50, :178:23, :179:24]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      beatsLeft <= 9'h0;	// @[Arbiter.scala:88:30, Edges.scala:229:27]
      ...
      if (idle & auto_out_a_ready) begin	// @[Arbiter.scala:89:28, :90:24]
        if (winnerQual_1 & ~(auto_in_a_bits_opcode[2]))	// @[Arbiter.scala:99:79, :112:73, Edges.scala:92:{28,37}, :221:14]
          beatsLeft <= ~(_decode_T_1[11:3]);	// @[Arbiter.scala:88:30, package.scala:235:{46,71,76}]
        else	// @[Arbiter.scala:112:73, Edges.scala:221:14]
          beatsLeft <= 9'h0;	// @[Arbiter.scala:88:30, Edges.scala:229:27]
      end
      else	// @[Arbiter.scala:90:24]
        beatsLeft <= beatsLeft - {8'h0, auto_out_a_ready & out_2_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, Bitwise.scala:77:12, ReadyValidCancel.scala:49:33]
  ...
  assign auto_out_a_bits_opcode = muxStateEarly_1 ? (a_isSupported ? auto_in_a_bits_opcode : 3'h4) : 3'h0;	// @[Arbiter.scala:118:30, AtomicAutomata.scala:94:32, :154:24, :155:31, :156:32, Misc.scala:201:34, Mux.scala:27:73]
  assign auto_out_a_bits_param = muxStateEarly_1 & a_isSupported ? auto_in_a_bits_param : 3'h0;	// @[Arbiter.scala:118:30, AtomicAutomata.scala:94:32, Misc.scala:201:34, Mux.scala:27:73]
