...
module TLInterconnectCoupler_17(
  ...
  wire [4:0]  _tl2axi4_auto_out_aw_bits_id;	// @[ToAXI4.scala:286:29]
  ...
  wire [4:0]  _tl2axi4_auto_out_aw_bits_echo_tl_state_source;	// @[ToAXI4.scala:286:29]
  ...
  wire [4:0]  _tl2axi4_auto_out_ar_bits_id;	// @[ToAXI4.scala:286:29]
  ...
  wire [4:0]  _tl2axi4_auto_out_ar_bits_echo_tl_state_source;	// @[ToAXI4.scala:286:29]
  ...
  wire [4:0]  _axi4index_auto_in_b_bits_id;	// @[IdIndexer.scala:94:31]
  ...
  wire [4:0]  _axi4index_auto_in_b_bits_echo_tl_state_source;	// @[IdIndexer.scala:94:31]
  wire        _axi4index_auto_in_ar_ready;	// @[IdIndexer.scala:94:31]
  wire        _axi4index_auto_in_r_valid;	// @[IdIndexer.scala:94:31]
  wire [4:0]  _axi4index_auto_in_r_bits_id;	// @[IdIndexer.scala:94:31]
  ...
  wire [4:0]  _axi4index_auto_in_r_bits_echo_tl_state_source;	// @[IdIndexer.scala:94:31]
  ...
  wire [4:0]  _axi4index_auto_out_aw_bits_echo_tl_state_source;	// @[IdIndexer.scala:94:31]
  wire        _axi4index_auto_out_aw_bits_echo_extra_id;	// @[IdIndexer.scala:94:31]
  ...
  wire [4:0]  _axi4index_auto_out_ar_bits_echo_tl_state_source;	// @[IdIndexer.scala:94:31]
  wire        _axi4index_auto_out_ar_bits_echo_extra_id;	// @[IdIndexer.scala:94:31]
  ...
  wire [4:0]  _axi4yank_auto_in_b_bits_echo_tl_state_source;	// @[UserYanker.scala:108:30]
  wire        _axi4yank_auto_in_b_bits_echo_extra_id;	// @[UserYanker.scala:108:30]
  ...
  wire [4:0]  _axi4yank_auto_in_r_bits_echo_tl_state_source;	// @[UserYanker.scala:108:30]
  wire        _axi4yank_auto_in_r_bits_echo_extra_id;	// @[UserYanker.scala:108:30]
