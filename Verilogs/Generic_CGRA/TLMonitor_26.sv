...
module TLMonitor_26(
  ...
  `ifndef SYNTHESIS	// @[Monitor.scala:42:11]
    ...
    wire            _GEN_19 = io_in_d_valid & io_in_d_bits_opcode == 3'h0;	// @[Monitor.scala:338:{25,51}, Parameters.scala:52:29]
    ...
    wire [259:0]    _a_opcode_lookup_T_1 = inflight_opcodes >> {251'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:613:35, :634:44]
    wire [519:0]    _GEN_22 = {510'h0, io_in_d_bits_source, 3'h0};	// @[Monitor.scala:638:40, Parameters.scala:52:29]
    ...
    wire [64:0]     _GEN_23 = {58'h0, io_in_d_bits_source};	// @[Monitor.scala:658:26, :682:25]
    wire            _GEN_24 = _T_938 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire            _GEN_25 = _T_938 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire [7:0]      _GEN_26 = {4'h0, io_in_d_bits_size};	// @[Monitor.scala:691:36, Parameters.scala:52:29]
    ...
    wire [64:0]     _T_939 = inflight >> _GEN_23;	// @[Monitor.scala:611:27, :682:25]
    wire [519:0]    _a_size_lookup_T_1 = inflight_sizes >> _GEN_22;	// @[Monitor.scala:615:33, :638:40]
    wire [127:0]    _d_clr_wo_ready_T = 128'h1 << _GEN_1;	// @[OneHot.scala:57:35]
    wire [64:0]     _T_1025 = 65'h0 >> _GEN_23;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire [519:0]    _c_size_lookup_T_1 = 520'h0 >> _GEN_22;	// @[Monitor.scala:638:40, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_15 & ~reset) begin	// @[Monitor.scala:49:11, :310:52]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_18 & ~reset & ~source_ok_1) begin	// @[Monitor.scala:49:11, :328:51, Parameters.scala:1126:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_18 & ~reset & ~io_in_d_bits_corrupt) begin	// @[Monitor.scala:49:11, :328:51]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel GrantData is denied but not corrupt (connected at CanHaveBuiltInDevices.scala:43:9)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_GEN_19 & ~reset & ~source_ok_1) begin	// @[Monitor.scala:49:11, :338:51, Parameters.scala:1126:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_20 & ~reset & ~source_ok_1) begin	// @[Monitor.scala:49:11, :346:55, Parameters.scala:1126:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel AccessAckData carries invalid source ID (connected at CanHaveBuiltInDevices.scala:43:9)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_GEN_20 & ~reset & ~io_in_d_bits_corrupt) begin	// @[Monitor.scala:49:11, :346:55]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel AccessAckData is denied but not corrupt (connected at CanHaveBuiltInDevices.scala:43:9)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_GEN_21 & ~reset & ~source_ok_1) begin	// @[Monitor.scala:49:11, :354:49, Parameters.scala:1126:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_T_888 & ~reset & (|param_1)) begin	// @[Monitor.scala:49:11, :536:22, :541:19, :543:29]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_T_888 & ~reset & sink) begin	// @[Monitor.scala:49:11, :539:22, :541:19]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel sink changed with multibeat operation (connected at CanHaveBuiltInDevices.scala:43:9)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_T_888 & ~reset & ~denied) begin	// @[Monitor.scala:49:11, :540:22, :541:19]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_25 & ~reset & _GEN_26 != {1'h0, _a_size_lookup_T_1[7:1]}) begin	// @[Monitor.scala:49:11, :638:{19,40}, :684:30, :691:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at CanHaveBuiltInDevices.scala:43:9)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      ...
      if (_T_1024 & ~reset & _GEN_26 != {1'h0, _c_size_lookup_T_1[7:1]}) begin	// @[Monitor.scala:49:11, :691:36, :747:{21,42}, :791:71, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at CanHaveBuiltInDevices.scala:43:9)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
  ...
  wire [1038:0] _d_opcodes_clr_T_5 = 1039'hF << {1030'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:677:76]
  wire [1026:0] _a_opcodes_set_T_1 = {1023'h0, _T_919 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {1018'h0, io_in_a_bits_source, 2'h0};	// @[Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, :657:52, Parameters.scala:52:29]
  ...
  wire          _T_914 = _T_1068 & ~(|d_first_counter);	// @[Decoupled.scala:51:35, Edges.scala:229:27, :231:25, Monitor.scala:549:20]
  ...
  always @(posedge clock) begin
    ...
    if (_T_914) begin	// @[Monitor.scala:549:20]
      opcode_1 <= io_in_d_bits_opcode;	// @[Monitor.scala:535:22]
      param_1 <= 2'h0;	// @[Monitor.scala:536:22]
      size_1 <= io_in_d_bits_size;	// @[Monitor.scala:537:22]
      source_1 <= io_in_d_bits_source;	// @[Monitor.scala:538:22]
    end
    sink <= ~_T_914 & sink;	// @[Monitor.scala:539:22, :549:{20,32}, :554:15]
    denied <= _T_914 | denied;	// @[Monitor.scala:540:22, :549:{20,32}, :555:15]
  end // always @(posedge)
  plusarg_reader #(
