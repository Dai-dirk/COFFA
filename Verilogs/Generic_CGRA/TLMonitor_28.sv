...
module TLMonitor_28(
  ...
  `ifndef SYNTHESIS	// @[Monitor.scala:42:11]
    ...
    wire            _GEN_5 = io_in_a_bits_source > 11'h40F;	// @[Parameters.scala:57:20]
    ...
    wire            _GEN_16 = io_in_d_bits_source > 11'h40F;	// @[Parameters.scala:57:20]
    ...
    wire [4159:0]   _GEN_24 = {4147'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:634:44, OneHot.scala:64:12]
    wire [4159:0]   _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_24;	// @[Monitor.scala:613:35, :634:44]
    ...
    wire [1039:0]   _GEN_25 = {1029'h0, io_in_d_bits_source};	// @[Monitor.scala:658:26, :682:25]
    ...
    wire [3:0]      _GEN_28 = {2'h0, io_in_d_bits_size};	// @[Monitor.scala:691:36, OneHot.scala:64:12]
    ...
    wire [1039:0]   _T_618 = inflight >> _GEN_25;	// @[Monitor.scala:611:27, :682:25]
    wire [4159:0]   _a_size_lookup_T_1 = inflight_sizes >> _GEN_24;	// @[Monitor.scala:615:33, :634:44, :638:40]
    wire [2047:0]   _d_clr_wo_ready_T = 2048'h1 << _GEN_0;	// @[OneHot.scala:57:35]
    wire [1039:0]   _T_704 = 1040'h0 >> _GEN_25;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire [4159:0]   _c_size_lookup_T_1 = 4160'h0 >> _GEN_24;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & io_in_a_bits_address[25:12] != 14'h2010) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(io_in_a_bits_source < 11'h410 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :114:53, :115:71, Parameters.scala:57:20, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(io_in_a_bits_source < 11'h410 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :122:56, :123:74, Parameters.scala:57:20, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_20 & ~reset & _GEN_16) begin	// @[Monitor.scala:49:11, :328:51, Parameters.scala:57:20]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_21 & ~reset & _GEN_16) begin	// @[Monitor.scala:49:11, :338:51, Parameters.scala:57:20]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_22 & ~reset & _GEN_16) begin	// @[Monitor.scala:49:11, :346:55, Parameters.scala:57:20]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_23 & ~reset & _GEN_16) begin	// @[Monitor.scala:49:11, :354:49, Parameters.scala:57:20]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_26 & ~reset & ~(io_in_d_bits_opcode == _GEN_2[io_in_a_bits_opcode] | io_in_d_bits_opcode == _GEN_1[io_in_a_bits_opcode])) begin	// @[Monitor.scala:49:11, :684:30, :685:{38,77}, :686:39]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_27 & ~reset & ~(io_in_d_bits_opcode == _GEN_2[_a_opcode_lookup_T_1[3:1]] | io_in_d_bits_opcode == _GEN_1[_a_opcode_lookup_T_1[3:1]])) begin	// @[Monitor.scala:49:11, :634:44, :684:30, :685:38, :686:39, :689:{38,72}, :690:38]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper opcode response (connected at Configs.scala:128:51)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_GEN_27 & ~reset & _GEN_28 != {1'h0, _a_size_lookup_T_1[3:1]}) begin	// @[Monitor.scala:49:11, :638:{19,40}, :684:30, :691:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at Configs.scala:128:51)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      ...
      if (_T_703 & ~reset & _GEN_28 != {1'h0, _c_size_lookup_T_1[3:1]}) begin	// @[Monitor.scala:49:11, :691:36, :747:{21,42}, :791:71, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at Configs.scala:128:51)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
  ...
  wire [16398:0] _GEN_29 = {16386'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:677:76, OneHot.scala:64:12]
  wire [2047:0]  _d_clr_T = 2048'h1 << _GEN_0;	// @[OneHot.scala:57:35]
  wire [2047:0]  _a_set_T = 2048'h1 << _GEN;	// @[OneHot.scala:57:35]
  wire [16398:0] _d_opcodes_clr_T_5 = 16399'hF << _GEN_29;	// @[Monitor.scala:677:76]
  ...
  wire [16398:0] _d_sizes_clr_T_5 = 16399'hF << _GEN_29;	// @[Monitor.scala:677:76, :678:74]
