...
module TLWidthWidget_1(
  ...
  wire [1:0]   _repeated_repeater_io_deq_bits_param;	// @[Repeater.scala:35:26]
  ...
  wire [3:0]   _repeated_repeater_io_deq_bits_sink;	// @[Repeater.scala:35:26]
  wire         _repeated_repeater_io_deq_bits_denied;	// @[Repeater.scala:35:26]
  wire [127:0] _repeated_repeater_io_deq_bits_data;	// @[Repeater.scala:35:26]
  wire         _repeated_repeater_io_deq_bits_corrupt;	// @[Repeater.scala:35:26]
  wire [18:0]  _limit_T_1 = 19'hF << auto_in_a_bits_size;	// @[package.scala:235:71]
  ...
  wire         x1_a_bits_corrupt = auto_in_a_bits_corrupt | corrupt_reg;	// @[WidthWidget.scala:40:32, :42:36]
  ...
  wire         x1_a_bits_mask_acc = (|(auto_in_a_bits_size[3:2])) | (&(auto_in_a_bits_size[1:0])) & ~(auto_in_a_bits_address[3]);	// @[Misc.scala:205:21, :208:26, :209:26, :210:20, :214:{29,38}, OneHot.scala:63:49]
  wire         x1_a_bits_mask_acc_1 = (|(auto_in_a_bits_size[3:2])) | (&(auto_in_a_bits_size[1:0])) & auto_in_a_bits_address[3];	// @[Misc.scala:205:21, :208:26, :209:26, :214:{29,38}, OneHot.scala:63:49]
  ...
  reg          repeat_sel_sel_sources_10;	// @[WidthWidget.scala:181:27]
  reg          repeat_sel_sel_sources_11;	// @[WidthWidget.scala:181:27]
  reg          repeat_sel_sel_sources_12;	// @[WidthWidget.scala:181:27]
  reg          repeat_sel_sel_sources_13;	// @[WidthWidget.scala:181:27]
  reg          repeat_sel_sel_sources_14;	// @[WidthWidget.scala:181:27]
  reg          repeat_sel_sel_sources_15;	// @[WidthWidget.scala:181:27]
  reg          repeat_sel_hold_r;	// @[Reg.scala:19:16]
  wire [15:0]  _GEN = {{repeat_sel_sel_sources_15}, {repeat_sel_sel_sources_14}, {repeat_sel_sel_sources_13}, {repeat_sel_sel_sources_12}, {repeat_sel_sel_sources_11}, {repeat_sel_sel_sources_10}, {repeat_sel_sel_sources_9}, {repeat_sel_sel_sources_8}, {repeat_sel_sel_sources_7}, {repeat_sel_sel_sources_6}, {repeat_sel_sel_sources_5}, {repeat_sel_sel_sources_4}, {repeat_sel_sel_sources_3}, {repeat_sel_sel_sources_2}, {repeat_sel_sel_sources_1}, {repeat_sel_sel_sources_0}};	// @[Reg.scala:20:22, WidthWidget.scala:181:27]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      x1_a_bits_data_rdata_written_once <= 1'h0;	// @[Edges.scala:92:28, WidthWidget.scala:57:41]
      x1_a_bits_mask_rdata_written_once <= 1'h0;	// @[Edges.scala:92:28, WidthWidget.scala:57:41]
      ...
      if (_repeat_sel_sel_T) begin	// @[Decoupled.scala:51:35]
        ...
        corrupt_reg <= ~last & x1_a_bits_corrupt;	// @[WidthWidget.scala:37:36, :40:32, :42:36, :45:15, :46:21, :47:21, :48:17, :49:23]
      end
    ...
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 4'hA)	// @[Decoupled.scala:51:35, WidthWidget.scala:181:27, :183:28, :184:37]
      repeat_sel_sel_sources_10 <= auto_in_a_bits_address[3];	// @[WidthWidget.scala:181:27, :182:38]
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 4'hB)	// @[Decoupled.scala:51:35, WidthWidget.scala:181:27, :183:28, :184:37]
      repeat_sel_sel_sources_11 <= auto_in_a_bits_address[3];	// @[WidthWidget.scala:181:27, :182:38]
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 4'hC)	// @[Decoupled.scala:51:35, WidthWidget.scala:181:27, :183:28, :184:37]
      repeat_sel_sel_sources_12 <= auto_in_a_bits_address[3];	// @[WidthWidget.scala:181:27, :182:38]
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 4'hD)	// @[Decoupled.scala:51:35, WidthWidget.scala:181:27, :183:28, :184:37]
      repeat_sel_sel_sources_13 <= auto_in_a_bits_address[3];	// @[WidthWidget.scala:181:27, :182:38]
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 4'hE)	// @[Decoupled.scala:51:35, WidthWidget.scala:181:27, :183:28, :184:37]
      repeat_sel_sel_sources_14 <= auto_in_a_bits_address[3];	// @[WidthWidget.scala:181:27, :182:38]
    if (_repeat_sel_sel_T & (&auto_in_a_bits_source))	// @[Decoupled.scala:51:35, WidthWidget.scala:181:27, :183:28, :184:37]
      repeat_sel_sel_sources_15 <= auto_in_a_bits_address[3];	// @[WidthWidget.scala:181:27, :182:38]
  ...
  TLMonitor_9 monitor (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
    .io_in_a_ready        (bundleIn_0_a_ready),	// @[WidthWidget.scala:71:29]
    ...
    .io_in_d_valid        (_repeated_repeater_io_deq_valid),	// @[Repeater.scala:35:26]
    .io_in_d_bits_opcode  (_repeated_repeater_io_deq_bits_opcode),	// @[Repeater.scala:35:26]
    .io_in_d_bits_param   (_repeated_repeater_io_deq_bits_param),	// @[Repeater.scala:35:26]
    .io_in_d_bits_size    (_repeated_repeater_io_deq_bits_size),	// @[Repeater.scala:35:26]
    .io_in_d_bits_source  (_repeated_repeater_io_deq_bits_source),	// @[Repeater.scala:35:26]
    .io_in_d_bits_sink    (_repeated_repeater_io_deq_bits_sink),	// @[Repeater.scala:35:26]
    .io_in_d_bits_denied  (_repeated_repeater_io_deq_bits_denied),	// @[Repeater.scala:35:26]
    .io_in_d_bits_corrupt (_repeated_repeater_io_deq_bits_corrupt)	// @[Repeater.scala:35:26]
  );
  ...
  assign auto_in_d_bits_param = _repeated_repeater_io_deq_bits_param;	// @[Repeater.scala:35:26]
  ...
  assign auto_in_d_bits_sink = _repeated_repeater_io_deq_bits_sink;	// @[Repeater.scala:35:26]
  assign auto_in_d_bits_denied = _repeated_repeater_io_deq_bits_denied;	// @[Repeater.scala:35:26]
  ...
  assign auto_in_d_bits_corrupt = _repeated_repeater_io_deq_bits_corrupt;	// @[Repeater.scala:35:26]
  ...
  assign auto_out_a_bits_corrupt = x1_a_bits_corrupt;	// @[WidthWidget.scala:42:36]
endmodule
