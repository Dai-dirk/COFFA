...
module TLXbar_11(
  ...
  wire        _portsAOI_in_0_a_ready_WIRE = ~(auto_in_a_bits_address[16]) & auto_out_0_a_ready | auto_in_a_bits_address[16] & auto_out_1_a_ready;	// @[Mux.scala:27:73, Parameters.scala:137:{45,65}]
  ...
  wire [10:0] out_9_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 11'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 11'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  wire [1:0]  out_9_bits_size = (muxStateEarly_0 ? auto_out_0_d_bits_size : 2'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_size : 2'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73]
