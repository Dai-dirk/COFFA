...
module TLXbar_4(
  ...
  wire        requestDOI_0_1 = auto_out_d_bits_source == 7'h40;	// @[Parameters.scala:46:9, Xbar.scala:427:24]
  wire        out_7_valid = auto_out_d_valid & ~(auto_out_d_bits_source[6]);	// @[Parameters.scala:54:{10,32}, Xbar.scala:182:40]
  wire        out_10_valid = auto_out_d_valid & requestDOI_0_1;	// @[Parameters.scala:46:9, Xbar.scala:182:40]
  ...
  TLMonitor_21 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_d_valid        (out_7_valid),	// @[Xbar.scala:182:40]
    .io_in_d_bits_opcode  (auto_out_d_bits_opcode),
    .io_in_d_bits_param   (auto_out_d_bits_param),
    .io_in_d_bits_size    (auto_out_d_bits_size),
    .io_in_d_bits_source  (auto_out_d_bits_source[5:0]),	// @[Xbar.scala:231:69]
    .io_in_d_bits_sink    (auto_out_d_bits_sink),
    .io_in_d_bits_denied  (auto_out_d_bits_denied),
    .io_in_d_bits_corrupt (auto_out_d_bits_corrupt)
  );
  TLMonitor_22 monitor_1 (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
  ...
  assign auto_in_1_d_valid = out_10_valid;	// @[Xbar.scala:182:40]
  assign auto_in_0_a_ready = portsAOI_filtered_0_ready;	// @[Arbiter.scala:124:31]
  assign auto_in_0_d_valid = out_7_valid;	// @[Xbar.scala:182:40]
  assign auto_in_0_d_bits_opcode = auto_out_d_bits_opcode;
  assign auto_in_0_d_bits_param = auto_out_d_bits_param;
  assign auto_in_0_d_bits_size = auto_out_d_bits_size;
  assign auto_in_0_d_bits_source = auto_out_d_bits_source[5:0];	// @[Xbar.scala:231:69]
  ...
  assign auto_out_a_bits_source = (muxStateEarly_0 ? {1'h0, auto_in_0_a_bits_source} : 7'h0) | {muxStateEarly_1, 6'h0};	// @[Arbiter.scala:118:30, Mux.scala:27:73, Xbar.scala:240:29, :265:23]
