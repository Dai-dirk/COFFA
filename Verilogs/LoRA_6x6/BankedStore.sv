...
module BankedStore(
  ...
  input  [7:0]   io_sinkC_adr_bits_set,
  ...
  input  [7:0]   io_sourceD_wadr_bits_set,
  ...
  wire [10:0] reqs_0_index = {io_sinkC_adr_bits_way, io_sinkC_adr_bits_set};	// @[BankedStore.scala:135:23]
  ...
  wire [10:0] reqs_2_index = {io_sinkD_adr_bits_way, io_sinkD_adr_bits_set};	// @[BankedStore.scala:135:23]
  ...
  wire [10:0] reqs_1_index = {io_sourceC_adr_bits_way, io_sourceC_adr_bits_set};	// @[BankedStore.scala:135:23]
  ...
  wire [10:0] reqs_4_index = {io_sourceD_radr_bits_way, io_sourceD_radr_bits_set};	// @[BankedStore.scala:135:23]
  ...
  wire [10:0] reqs_3_index = {io_sourceD_wadr_bits_way, io_sourceD_wadr_bits_set};	// @[BankedStore.scala:135:23]
