...
module MemoryBus(
  ...
  wire [4:0]  _coupler_to_memory_controller_port_named_axi4_auto_widget_in_d_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [4:0]  _coupler_to_memory_controller_port_named_axi4_auto_tl_in_d_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [2:0]  _coupler_to_memory_controller_port_named_axi4_auto_tl_out_a_bits_param;	// @[LazyModule.scala:489:27]
  wire [2:0]  _coupler_to_memory_controller_port_named_axi4_auto_tl_out_a_bits_size;	// @[LazyModule.scala:489:27]
  wire [4:0]  _coupler_to_memory_controller_port_named_axi4_auto_tl_out_a_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire        _coupler_to_memory_controller_port_named_axi4_auto_tl_out_a_bits_corrupt;	// @[LazyModule.scala:489:27]
  ...
  wire [4:0]  _picker_auto_in_d_bits_source;	// @[ProbePicker.scala:66:28]
  ...
  wire [4:0]  _picker_auto_out_a_bits_source;	// @[ProbePicker.scala:66:28]
  ...
  wire [4:0]  _fixer_auto_out_a_bits_source;	// @[FIFOFixer.scala:146:27]
  ...
  TLInterconnectCoupler_17 coupler_to_memory_controller_port_named_axi4 (	// @[LazyModule.scala:489:27]
    .clock                           (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                           (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
    ...
    .auto_widget_in_a_bits_param     (_coupler_to_memory_controller_port_named_axi4_auto_tl_out_a_bits_param),	// @[LazyModule.scala:489:27]
    ...
    .auto_widget_in_a_bits_corrupt   (_coupler_to_memory_controller_port_named_axi4_auto_tl_out_a_bits_corrupt),	// @[LazyModule.scala:489:27]
