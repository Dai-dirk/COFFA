...
module MulAddRecFNPipe_1(
  ...
  wire [12:0]  _mulAddRecFNToRaw_postMul_io_rawOut_sExp;	// @[FPU.scala:647:42]
  wire [55:0]  _mulAddRecFNToRaw_postMul_io_rawOut_sig;	// @[FPU.scala:647:42]
  wire [52:0]  _mulAddRecFNToRaw_preMul_io_mulAddA;	// @[FPU.scala:646:41]
  wire [52:0]  _mulAddRecFNToRaw_preMul_io_mulAddB;	// @[FPU.scala:646:41]
  wire [105:0] _mulAddRecFNToRaw_preMul_io_mulAddC;	// @[FPU.scala:646:41]
  ...
  wire [12:0]  _mulAddRecFNToRaw_preMul_io_toPostMul_sExpSum;	// @[FPU.scala:646:41]
  ...
  wire [5:0]   _mulAddRecFNToRaw_preMul_io_toPostMul_CDom_CAlignDist;	// @[FPU.scala:646:41]
  wire [54:0]  _mulAddRecFNToRaw_preMul_io_toPostMul_highAlignedSigC;	// @[FPU.scala:646:41]
  ...
  always @(posedge clock) begin
    if (io_validin) begin
      ...
      mulAddRecFNToRaw_postMul_io_mulAddResult_b <= {1'h0, {53'h0, _mulAddRecFNToRaw_preMul_io_mulAddA} * {53'h0, _mulAddRecFNToRaw_preMul_io_mulAddB}} + {1'h0, _mulAddRecFNToRaw_preMul_io_mulAddC};	// @[FPU.scala:646:41, :655:45, :656:50, Reg.scala:19:16, Valid.scala:130:22]
