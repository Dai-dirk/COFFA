...
module PTW(
  ...
  wire [7:0]      _T_180;	// @[PTW.scala:484:54]
  wire            readEnable;	// @[PTW.scala:479:31]
  wire            writeEnable;	// @[PTW.scala:445:21]
  wire [7:0]      writeAddr;	// @[package.scala:155:13]
  ...
  wire [45:0]     _l2_tlb_ram_0_RW0_rdata;	// @[DescribedSRAM.scala:17:26]
  ...
  reg  [255:0]    REG_0;	// @[PTW.scala:433:16]
  reg  [255:0]    REG_1_0;	// @[PTW.scala:434:24]
  assign writeAddr = r_req_addr[7:0];	// @[PTW.scala:270:18, package.scala:155:13]
  ...
  assign _T_180 = _arb_io_out_bits_bits_addr[7:0];	// @[PTW.scala:236:19, :484:54]
  reg  [45:0]     r_2;	// @[Reg.scala:19:16]
  reg             r_3;	// @[Reg.scala:19:16]
  reg             r_4_0;	// @[Reg.scala:19:16]
  wire            l2_error = r_3 & ^r_2;	// @[ECC.scala:78:27, PTW.scala:488:81, Reg.scala:19:16]
  wire            _T_197 = r_3 & {r_req_vstage1, r_req_addr[26:8]} == {1'h0, r_2[44:26]};	// @[PTW.scala:270:18, :491:59, :492:{83,93}, Reg.scala:19:16, package.scala:155:13]
  ...
  `ifndef SYNTHESIS	// @[PTW.scala:407:9]
  ...
  wire [255:0]    _GEN_20 = {248'h0, writeAddr};	// @[PTW.scala:438:34, package.scala:155:13]
  wire [255:0]    _T_152 = 256'h1 << _GEN_20;	// @[OneHot.scala:57:35, PTW.scala:438:34]
  wire            _GEN_21 = r_req_dest == 2'h0;	// @[PTW.scala:272:23, :644:32]
  wire            _GEN_22 = r_req_dest == 2'h1;	// @[PTW.scala:272:23, :644:32]
  wire            _GEN_23 = r_req_dest == 2'h2;	// @[PTW.scala:272:23, :644:32]
  wire            _GEN_24 = ~_GEN_10 & (_T_214 ? io_mem_s2_xcpt_ae_ld & _GEN_21 : (&state) & _GEN_21);	// @[PTW.scala:233:22, :242:27, :405:26, :585:18, :641:35, :644:32, :649:30]
  wire            _GEN_25 = ~_GEN_10 & (_T_214 ? io_mem_s2_xcpt_ae_ld & _GEN_22 : (&state) & _GEN_22);	// @[PTW.scala:233:22, :242:27, :405:26, :585:18, :641:35, :644:32, :649:30]
  wire            _GEN_26 = ~_GEN_10 & (_T_214 ? io_mem_s2_xcpt_ae_ld & _GEN_23 : (&state) & _GEN_23);	// @[PTW.scala:233:22, :242:27, :405:26, :585:18, :641:35, :644:32, :649:30]
  wire            _GEN_27 = _T_222 & _GEN_21;	// @[PTW.scala:585:18, :644:32, :683:{16,30}, :686:28]
  wire            _GEN_28 = _T_222 & _GEN_22;	// @[PTW.scala:585:18, :644:32, :683:{16,30}, :686:28]
  wire            _GEN_29 = _T_222 & _GEN_23;	// @[PTW.scala:585:18, :644:32, :683:{16,30}, :686:28]
  wire [255:0]    _T_144 = REG_1_0 >> _GEN_20;	// @[PTW.scala:434:24, :438:34]
  wire [255:0]    _T_181 = REG_0 >> _GEN_20;	// @[PTW.scala:433:16, :438:34, :487:45]
  always @(posedge clock) begin
    if (reset) begin
      ...
      REG_1_0 <= 256'h0;	// @[PTW.scala:434:{24,32}]
    end
    else begin
      ...
      if (REG_5 & l2_error)	// @[PTW.scala:482:27, :488:81, :489:20]
        ...
        if (io_dpath_sfence_bits_rs1)
          REG_1_0 <= REG_1_0 & ~(256'h1 << io_dpath_sfence_bits_addr[19:12]);	// @[OneHot.scala:57:35, PTW.scala:434:24, :473:{59,61,96}]
        ...
        REG_1_0 <= {256{writeEnable}} & _T_152 | REG_1_0;	// @[OneHot.scala:57:35, PTW.scala:434:24, :445:{21,38}, :462:27]
    end
    if (~mem_resp_valid | _GEN_14) begin	// @[PTW.scala:293:31, :410:26, :674:8, :683:30, :689:25, :692:21, :701:57, :711:19]
      resp_valid_0 <= _GEN_27 | _GEN_24;	// @[PTW.scala:242:27, :585:18, :683:30, :686:28]
      resp_valid_1 <= _GEN_28 | _GEN_25;	// @[PTW.scala:242:27, :585:18, :683:30, :686:28]
      resp_valid_2 <= _GEN_29 | _GEN_26;	// @[PTW.scala:242:27, :585:18, :683:30, :686:28]
      ...
      resp_valid_0 <= _GEN_21 | _GEN_27 | _GEN_24;	// @[PTW.scala:242:27, :585:18, :644:32, :683:30, :686:28, :720:34]
      resp_valid_1 <= _GEN_22 | _GEN_28 | _GEN_25;	// @[PTW.scala:242:27, :585:18, :644:32, :683:30, :686:28, :720:34]
      resp_valid_2 <= _GEN_23 | _GEN_29 | _GEN_26;	// @[PTW.scala:242:27, :585:18, :644:32, :683:30, :686:28, :720:34]
  ...
  l2_tlb_ram_0 l2_tlb_ram_0 (	// @[DescribedSRAM.scala:17:26]
    ...
    .RW0_wdata ({^{r_req_addr[26:8], r_pte_ppn[19:0], r_pte_d, r_pte_a, r_pte_u, r_pte_x, r_pte_w, r_pte_r}, r_req_addr[26:8], r_pte_ppn[19:0], r_pte_d, r_pte_a, r_pte_u, r_pte_x, r_pte_w, r_pte_r}),	// @[Cat.scala:33:92, ECC.scala:72:55, PTW.scala:270:18, :275:18, :447:17, :454:17, :458:82, package.scala:155:13]
    .RW0_rdata (_l2_tlb_ram_0_RW0_rdata)
  );
  OptimizationBarrier_56 state_barrier (	// @[package.scala:259:25]
  ...
  OptimizationBarrier_57 r_pte_barrier (	// @[package.scala:259:25]
