...
module Queue_11(
  ...
  wire [103:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[16:10];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_address = _ram_ext_R0_data[30:17];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[38:31];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[102:39];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[103];	// @[Decoupled.scala:273:95]
endmodule
