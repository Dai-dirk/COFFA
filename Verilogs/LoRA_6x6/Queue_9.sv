...
module Queue_9(
  ...
  wire [82:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_sink = _ram_ext_R0_data[16];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_denied = _ram_ext_R0_data[17];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[81:18];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[82];	// @[Decoupled.scala:273:95]
endmodule
