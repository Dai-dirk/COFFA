...
module RecFNToIN_1(
  ...
  wire [83:0] shiftedSig = {31'h0, io_in[63], io_in[51:0]} << (io_in[63] ? io_in[56:52] : 5'h0);	// @[RecFNToIN.scala:58:30, :80:50, :81:16, :82:27, rawFloatFromRecFN.scala:60:51]
  ...
  wire        common_overflow = io_in[63] ? (|(io_in[62:57])) | (io_signedOut ? (io_in[64] ? magGeOne_atOverflowEdge & ((|(shiftedSig[82:52])) | roundIncr) : magGeOne_atOverflowEdge | io_in[62:52] == 11'h1E & roundCarryBut2) : io_in[64] | magGeOne_atOverflowEdge & shiftedSig[82] & roundCarryBut2) : ~io_signedOut & io_in[64] & roundIncr;	// @[RecFNToIN.scala:58:30, :59:28, :80:50, :87:54, :98:46, :107:43, :110:61, :112:12, :113:{21,40}, :114:20, :115:24, :116:49, :117:{42,60,64}, :118:49, :119:{38,62}, :121:32, :123:{42,57}, :125:{13,41}, rawFloatFromRecFN.scala:58:25]
  wire        invalidExc = (&(io_in[63:62])) & io_in[61] | (&(io_in[63:62])) & ~(io_in[61]);	// @[RecFNToIN.scala:130:34, rawFloatFromRecFN.scala:50:21, :52:{29,54}, :55:{33,41}, :56:{33,36}]
