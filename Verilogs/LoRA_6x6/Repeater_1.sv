...
module Repeater_1(
  ...
  reg  [3:0]   saved_sink;	// @[Repeater.scala:20:18]
  ...
  always @(posedge clock) begin
    ...
    if (_T_1) begin	// @[Repeater.scala:28:23]
      ...
      saved_sink <= io_enq_bits_sink;	// @[Repeater.scala:20:18]
      saved_denied <= io_enq_bits_denied;	// @[Repeater.scala:20:18]
  ...
  assign io_deq_bits_sink = full ? saved_sink : io_enq_bits_sink;	// @[Repeater.scala:19:21, :20:18, :25:21]
  assign io_deq_bits_denied = full ? saved_denied : io_enq_bits_denied;	// @[Repeater.scala:19:21, :20:18, :25:21]
