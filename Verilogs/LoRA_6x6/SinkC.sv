...
module SinkC(
  ...
  wire [1:0]   beats1 = _c_io_deq_bits_opcode[0] ? ~(_beats1_decode_T_1[5:4]) : 2'h0;	// @[Decoupled.scala:375:21, Edges.scala:102:36, :221:14, :229:27, package.scala:235:{46,71,76}]
  reg  [1:0]   counter;	// @[Edges.scala:229:27]
  wire [1:0]   counter1 = counter - 2'h1;	// @[Edges.scala:229:27, :230:28]
  wire         last = counter == 2'h1 | beats1 == 2'h0;	// @[Edges.scala:221:14, :229:27, :232:{25,33,43}]
  wire [1:0]   beat = beats1 & ~counter1;	// @[Edges.scala:221:14, :230:28, :234:{25,27}]
  ...
  `ifndef SYNTHESIS	// @[SinkC.scala:90:12]
  ...
  reg  [7:0]   io_set_r;	// @[Reg.scala:19:16]
  wire [7:0]   _io_set_output = _c_io_deq_valid ? _c_io_deq_bits_address[13:6] : io_set_r;	// @[Cat.scala:33:92, Decoupled.scala:375:21, Parameters.scala:214:22, :216:28, Reg.scala:19:16, SinkC.scala:92:18]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      lists <= 2'h0;	// @[Edges.scala:229:27, SinkC.scala:116:24]
    end
    else begin
      ...
      lists <= (lists | (~resp & _c_io_deq_valid & ~(|counter) & _c_io_deq_bits_opcode[0] & ~req_block & ~buf_block ? _GEN : 2'h0)) & ~(_T_25 & io_rel_pop_bits_last ? 2'h1 << io_rel_pop_bits_index[0] : 2'h0);	// @[Decoupled.scala:51:35, :375:21, Edges.scala:102:36, :229:27, :231:25, :232:25, OneHot.scala:63:49, :64:12, SinkC.scala:79:19, :116:24, :118:29, :119:29, :120:{21,34,36}, :123:41, :126:27, :127:29, :134:{56,70}, :136:21, :138:{62,77,89}, :163:{27,52}, :164:17]
    end
    if (_c_io_deq_valid) begin	// @[Decoupled.scala:375:21]
      resp_r <= raw_resp;	// @[Reg.scala:19:16, SinkC.scala:78:58]
      io_set_r <= _c_io_deq_bits_address[13:6];	// @[Cat.scala:33:92, Decoupled.scala:375:21, Parameters.scala:214:22, :216:28, Reg.scala:19:16]
      bs_adr_bits_beat_r <= beat + {1'h0, _io_bs_adr_q_io_enq_ready};	// @[Decoupled.scala:375:21, Edges.scala:230:28, :234:25, Reg.scala:19:16, SinkC.scala:103:59]
    end
  ...
  Queue_57 c (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_58 io_bs_adr_q (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
  ...
  assign io_req_bits_tag = _c_io_deq_bits_address[27:14];	// @[Cat.scala:33:92, Decoupled.scala:375:21, Parameters.scala:214:22, :215:19]
  ...
  assign io_req_bits_set = _c_io_deq_bits_address[13:6];	// @[Cat.scala:33:92, Decoupled.scala:375:21, Parameters.scala:214:22, :216:28]
  ...
  assign io_resp_bits_set = _c_io_deq_bits_address[13:6];	// @[Cat.scala:33:92, Decoupled.scala:375:21, Parameters.scala:214:22, :216:28]
  assign io_resp_bits_tag = _c_io_deq_bits_address[27:14];	// @[Cat.scala:33:92, Decoupled.scala:375:21, Parameters.scala:214:22, :215:19]
