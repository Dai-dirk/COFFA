...
module SourceD(
  ...
  input  [7:0]   io_evict_req_set,
  input  [2:0]   io_evict_req_way,
  input  [7:0]   io_grant_req_set,
  ...
  reg  [7:0]      s1_req_reg_set;	// @[Reg.scala:19:16]
  ...
  wire [7:0]      s1_req_set = busy ? s1_req_reg_set : io_req_bits_set;	// @[Reg.scala:19:16, SourceD.scala:84:21, :88:19]
  ...
  reg  [7:0]      s2_req_set;	// @[Reg.scala:19:16]
  ...
  reg  [7:0]      s3_req_set;	// @[Reg.scala:19:16]
  ...
  reg  [7:0]      s4_req_set;	// @[Reg.scala:19:16]
  ...
  `ifndef SYNTHESIS	// @[SourceD.scala:123:10]
  ...
  reg  [7:0]      s5_req_set;	// @[Reg.scala:19:16]
  ...
  reg  [7:0]      s6_req_set;	// @[Reg.scala:19:16]
  ...
  wire [7:0]      pre_s3_req_set = s3_latch ? s2_req_set : s3_req_set;	// @[Reg.scala:19:16, SourceD.scala:177:18, :315:24]
  ...
  Queue_54 queue (	// @[SourceD.scala:120:21]
    .clock            (clock),
    .reset            (reset),
