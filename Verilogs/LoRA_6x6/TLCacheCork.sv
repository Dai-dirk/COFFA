...
module TLCacheCork(
  ...
  wire        toD = _T & auto_in_a_bits_param == 3'h2 | (&auto_in_a_bits_opcode);	// @[CacheCork.scala:69:{37,54,73,97}, :70:37]
  ...
  wire        _c_a_bits_a_mask_T = auto_in_c_bits_size > 3'h2;	// @[CacheCork.scala:69:73, Misc.scala:205:21]
  ...
  reg         wSourceVec_5;	// @[CacheCork.scala:139:29]
  reg         wSourceVec_6;	// @[CacheCork.scala:139:29]
  reg         wSourceVec_7;	// @[CacheCork.scala:139:29]
  reg         wSourceVec_8;	// @[CacheCork.scala:139:29]
  reg         wSourceVec_9;	// @[CacheCork.scala:139:29]
  wire [15:0] _GEN = {{wSourceVec_0}, {wSourceVec_0}, {wSourceVec_0}, {wSourceVec_0}, {wSourceVec_0}, {wSourceVec_0}, {wSourceVec_9}, {wSourceVec_8}, {wSourceVec_7}, {wSourceVec_6}, {wSourceVec_5}, {wSourceVec_4}, {wSourceVec_3}, {wSourceVec_2}, {wSourceVec_1}, {wSourceVec_0}};	// @[CacheCork.scala:139:29, :143:25]
  wire        _GEN_0 = _GEN[auto_out_d_bits_source[4:1]];	// @[CacheCork.scala:135:46, :143:25]
  reg         dWHeld_r;	// @[Reg.scala:19:16]
  wire        _T_18 = auto_out_d_bits_opcode == 3'h1 & auto_out_d_bits_source[0];	// @[CacheCork.scala:154:{33,51,71}, Misc.scala:201:81]
  ...
  `ifndef SYNTHESIS	// @[CacheCork.scala:108:16]
  ...
  wire [3:0]  out_6_bits_source = (muxStateEarly_1_0 ? auto_out_d_bits_source[4:1] : 4'h0) | (muxStateEarly_1_1 ? _q_io_deq_bits_source : 4'h0) | (muxStateEarly_1_2 ? _q_1_io_deq_bits_source : 4'h0);	// @[Arbiter.scala:118:30, CacheCork.scala:135:46, Decoupled.scala:375:21, Mux.scala:27:73, Nodes.scala:1215:84]
  ...
  always @(posedge clock) begin
    ...
    wSourceVec_0 <= _T_15 & auto_in_a_bits_source == 4'h0 | wSourceVec_0;	// @[CacheCork.scala:139:29, :145:26, :146:40, Decoupled.scala:51:35, Nodes.scala:1215:84]
    wSourceVec_1 <= _T_15 & auto_in_a_bits_source == 4'h1 | wSourceVec_1;	// @[CacheCork.scala:139:29, :145:26, :146:40, Decoupled.scala:51:35]
    wSourceVec_2 <= _T_15 & auto_in_a_bits_source == 4'h2 | wSourceVec_2;	// @[CacheCork.scala:139:29, :145:26, :146:40, Decoupled.scala:51:35]
    wSourceVec_3 <= _T_15 & auto_in_a_bits_source == 4'h3 | wSourceVec_3;	// @[CacheCork.scala:139:29, :145:26, :146:40, Decoupled.scala:51:35]
    wSourceVec_4 <= _T_15 & auto_in_a_bits_source == 4'h4 | wSourceVec_4;	// @[CacheCork.scala:139:29, :145:26, :146:40, Decoupled.scala:51:35]
    wSourceVec_5 <= _T_15 & auto_in_a_bits_source == 4'h5 | wSourceVec_5;	// @[CacheCork.scala:139:29, :145:26, :146:40, Decoupled.scala:51:35]
    wSourceVec_6 <= _T_15 & auto_in_a_bits_source == 4'h6 | wSourceVec_6;	// @[CacheCork.scala:139:29, :145:26, :146:40, Decoupled.scala:51:35]
    wSourceVec_7 <= _T_15 & auto_in_a_bits_source == 4'h7 | wSourceVec_7;	// @[CacheCork.scala:139:29, :145:26, :146:40, Decoupled.scala:51:35]
    wSourceVec_8 <= _T_15 & auto_in_a_bits_source == 4'h8 | wSourceVec_8;	// @[CacheCork.scala:139:29, :145:26, :146:40, Decoupled.scala:51:35]
    wSourceVec_9 <= _T_15 & auto_in_a_bits_source == 4'h9 | wSourceVec_9;	// @[CacheCork.scala:139:29, :145:26, :146:40, Decoupled.scala:51:35]
  end // always @(posedge)
  ...
  Queue_59 q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_59 q_1 (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  assign auto_out_a_bits_source = (muxStateEarly_0 ? {auto_in_c_bits_source, 1'h0} : 5'h0) | (muxStateEarly_1 ? {auto_in_a_bits_source, _T_2 | auto_in_a_bits_opcode == 3'h0 | auto_in_a_bits_opcode == 3'h1} : 5'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, CacheCork.scala:68:{38,74}, :75:25, :78:{49,86}, :81:27, :96:41, Misc.scala:201:81, Mux.scala:27:73, Nodes.scala:1215:84]
