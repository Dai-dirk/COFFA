...
module TLDebugModuleOuterAsync(
  ...
  wire [1:0]  _asource_auto_in_d_bits_size;	// @[AsyncCrossing.scala:89:29]
  wire        _asource_auto_in_d_bits_source;	// @[AsyncCrossing.scala:89:29]
  ...
  wire [2:0]  _dmiBypass_auto_node_in_in_d_bits_opcode;	// @[Debug.scala:695:29]
  wire [1:0]  _dmiBypass_auto_node_in_in_d_bits_param;	// @[Debug.scala:695:29]
  wire [1:0]  _dmiBypass_auto_node_in_in_d_bits_size;	// @[Debug.scala:695:29]
  ...
  wire [2:0]  _dmOuter_auto_dmi_in_d_bits_opcode;	// @[Debug.scala:692:27]
  ...
  TLXbar_10 dmiXbar (	// @[Debug.scala:667:28]
    .clock                     (io_dmi_clock),
    .reset                     (io_dmi_reset),
    ...
    .auto_out_1_d_bits_opcode  (_dmOuter_auto_dmi_in_d_bits_opcode),	// @[Debug.scala:692:27]
    ...
    .auto_out_0_d_bits_opcode  (_dmiBypass_auto_node_in_in_d_bits_opcode),	// @[Debug.scala:695:29]
    .auto_out_0_d_bits_param   (_dmiBypass_auto_node_in_in_d_bits_param),	// @[Debug.scala:695:29]
    .auto_out_0_d_bits_size    (_dmiBypass_auto_node_in_in_d_bits_size),	// @[Debug.scala:695:29]
  ...
  TLBusBypass dmiBypass (	// @[Debug.scala:695:29]
    ...
    .auto_node_out_out_d_bits_param   (_asource_auto_in_d_bits_param),	// @[AsyncCrossing.scala:89:29]
    .auto_node_out_out_d_bits_size    (_asource_auto_in_d_bits_size),	// @[AsyncCrossing.scala:89:29]
    .auto_node_out_out_d_bits_source  (_asource_auto_in_d_bits_source),	// @[AsyncCrossing.scala:89:29]
  ...
  AsyncQueueSource_3 io_innerCtrl_source (	// @[AsyncQueue.scala:216:24]
    .clock                        (io_dmi_clock),
    .reset                        (io_dmi_reset),
