...
module TLError(
  ...
  TLMonitor_26 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_d_valid        (da_valid),	// @[Error.scala:33:25]
    .io_in_d_bits_opcode  (da_bits_opcode),	// @[Error.scala:35:21]
    ...
    .io_in_d_bits_corrupt (da_bits_opcode[0])	// @[Edges.scala:106:36, Error.scala:35:21]
  );
