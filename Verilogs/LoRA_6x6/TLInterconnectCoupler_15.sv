...
module TLInterconnectCoupler_15(
  ...
  input  [1:0]  auto_fixer_out_d_bits_size,
  input  [10:0] auto_fixer_out_d_bits_source,
  ...
  output [1:0]  auto_fixer_out_a_bits_size,
  output [10:0] auto_fixer_out_a_bits_source,
  ...
  wire [20:0] _buffer_auto_out_a_bits_address;	// @[Buffer.scala:69:28]
  ...
  wire [20:0] _fragmenter_auto_out_a_bits_address;	// @[Fragmenter.scala:335:34]
  ...
  wire [1:0]  _fixer_auto_in_d_bits_size;	// @[FIFOFixer.scala:146:27]
  wire [10:0] _fixer_auto_in_d_bits_source;	// @[FIFOFixer.scala:146:27]
  ...
  TLBuffer_8 buffer (	// @[Buffer.scala:69:28]
    .clock                   (clock),
    .reset                   (reset),
