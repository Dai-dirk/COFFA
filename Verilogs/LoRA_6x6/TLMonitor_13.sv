...
module TLMonitor_13(
  ...
  wire          _T_1052 = io_in_a_ready & io_in_a_valid;	// @[Decoupled.scala:51:35]
  ...
  wire          _T_976 = _T_1052 & a_first_1;	// @[Decoupled.scala:51:35, Edges.scala:231:25, Monitor.scala:652:27]
  ...
  `ifndef SYNTHESIS	// @[Monitor.scala:42:11]
    ...
    wire            _GEN_16 = io_in_d_bits_size < 3'h3;	// @[Bundles.scala:148:30, Monitor.scala:312:27]
    ...
    wire            _T_921 = io_in_a_valid & (|a_first_counter);	// @[Edges.scala:229:27, :231:25, Monitor.scala:389:19]
    wire            _T_945 = io_in_d_valid & (|d_first_counter);	// @[Edges.scala:229:27, :231:25, Monitor.scala:541:19]
    wire [259:0]    _GEN_23 = {251'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:634:44, Parameters.scala:54:32]
    wire [259:0]    _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_23;	// @[Monitor.scala:613:35, :634:44]
    ...
    wire            _T_1024 = io_in_d_valid & d_first_1;	// @[Edges.scala:231:25, Monitor.scala:671:26]
    wire            _T_995 = _T_1024 & ~d_release_ack;	// @[Monitor.scala:670:46, :671:{26,74}, :680:71]
    ...
    wire            _GEN_25 = _T_995 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire            _GEN_26 = _T_995 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire            _T_1081 = io_in_d_valid & d_first_2 & d_release_ack;	// @[Edges.scala:231:25, Monitor.scala:670:46, :791:71]
    wire [64:0]     _T_977 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire [64:0]     _T_996 = inflight >> _GEN_24;	// @[Monitor.scala:611:27, :682:25]
    wire [259:0]    _a_size_lookup_T_1 = inflight_sizes >> _GEN_23;	// @[Monitor.scala:615:33, :634:44, :638:40]
    wire [127:0]    _d_clr_wo_ready_T = 128'h1 << _GEN_1;	// @[OneHot.scala:57:35]
    wire [64:0]     _T_1082 = 65'h0 >> _GEN_24;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire [259:0]    _c_size_lookup_T_1 = 260'h0 >> _GEN_23;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_5 & ~reset & ~(_WIRE_2_3 & io_in_a_bits_size == 3'h6 & (io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :81:{25,54}, :83:78, Parameters.scala:46:9, :91:48, :137:{31,65}, :672:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_5 & ~reset & ~_T_328) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :81:54]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_7 & ~reset & ~(_WIRE_2_3 & io_in_a_bits_size == 3'h6 & (io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :81:25, :92:53, :94:78, Parameters.scala:46:9, :91:48, :137:{31,65}, :672:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_7 & ~reset & ~_T_328) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :92:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~(~(|(io_in_a_bits_source[6:4])) | io_in_a_bits_source[6:3] == 4'h3 | io_in_a_bits_source[6:3] == 4'h2 | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6)) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:46:9, :54:{10,32}, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
          $error("Assertion failed: 'A' channel carries Get type which master claims it can't emit (connected at PeripheryBus.scala:58:7)\n    at Monitor.scala:42 assert(cond, message)\n");	// @[Monitor.scala:42:11]
        if (`STOP_COND_)	// @[Monitor.scala:42:11]
          $fatal;	// @[Monitor.scala:42:11]
      end
      if (_GEN_8 & ~reset & ~(io_in_a_bits_size != 3'h7 & (io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :92:25, :104:45, Parameters.scala:92:42, :137:{31,65}, :671:54, :672:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & (|_GEN_4)) begin	// @[Edges.scala:21:{16,24}, Monitor.scala:42:11, :114:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & (|_GEN_4)) begin	// @[Edges.scala:21:{16,24}, Monitor.scala:42:11, :122:56]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_12 & ~reset & (|_GEN_4)) begin	// @[Edges.scala:21:{16,24}, Monitor.scala:42:11, :130:56]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & (|_GEN_4)) begin	// @[Edges.scala:21:{16,24}, Monitor.scala:42:11, :138:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & (|_GEN_4)) begin	// @[Edges.scala:21:{16,24}, Monitor.scala:42:11, :146:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_26 & ~reset & ~(io_in_d_bits_opcode == _GEN_3[_a_opcode_lookup_T_1[3:1]] | io_in_d_bits_opcode == _GEN_2[_a_opcode_lookup_T_1[3:1]])) begin	// @[Monitor.scala:49:11, :634:44, :684:30, :685:38, :686:39, :689:{38,72}, :690:38]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper opcode response (connected at PeripheryBus.scala:58:7)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_GEN_26 & ~reset & io_in_d_bits_size != _a_size_lookup_T_1[3:1]) begin	// @[Monitor.scala:49:11, :638:40, :684:30, :691:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at PeripheryBus.scala:58:7)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_T_1024 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin	// @[Edges.scala:231:25, Monitor.scala:49:11, :670:46, :671:{26,74}, :694:90, :695:{15,32}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(a_set_wo_ready != (_T_1024 & ~d_release_ack ? _d_clr_wo_ready_T[64:0] : 65'h0) | a_set_wo_ready == 65'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_T_1081 & ~reset & ~(_T_1082[0])) begin	// @[Monitor.scala:49:11, :791:71, :793:25]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at PeripheryBus.scala:58:7)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_T_1081 & ~reset & io_in_d_bits_size != _c_size_lookup_T_1[3:1]) begin	// @[Monitor.scala:49:11, :747:42, :791:71, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at PeripheryBus.scala:58:7)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
  ...
  wire [12:0]   _GEN_27 = {10'h0, io_in_d_bits_size};	// @[package.scala:235:71]
  wire [12:0]   _d_first_beats1_decode_T_1 = 13'h3F << _GEN_27;	// @[package.scala:235:71]
  wire [12:0]   _d_first_beats1_decode_T_5 = 13'h3F << _GEN_27;	// @[package.scala:235:71]
  wire [12:0]   _d_first_beats1_decode_T_9 = 13'h3F << _GEN_27;	// @[package.scala:235:71]
  wire [1026:0] _GEN_28 = {1018'h0, io_in_a_bits_source, 2'h0};	// @[Monitor.scala:656:54, Parameters.scala:54:32]
  wire [1038:0] _GEN_29 = {1030'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:677:76, Parameters.scala:54:32]
  wire [127:0]  _d_clr_T = 128'h1 << _GEN_1;	// @[OneHot.scala:57:35]
  wire [127:0]  _a_set_T = 128'h1 << _GEN_0;	// @[OneHot.scala:57:35]
  wire [1038:0] _d_opcodes_clr_T_5 = 1039'hF << _GEN_29;	// @[Monitor.scala:677:76]
  wire [1026:0] _a_opcodes_set_T_1 = {1023'h0, _T_976 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_28;	// @[Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, Parameters.scala:52:29]
  wire [1038:0] _d_sizes_clr_T_5 = 1039'hF << _GEN_29;	// @[Monitor.scala:677:76, :678:74]
  wire [1026:0] _a_sizes_set_T_1 = {1023'h0, _T_976 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_28;	// @[Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52, Parameters.scala:52:29]
  wire          _T_1125 = io_in_d_ready & io_in_d_valid;	// @[Decoupled.scala:51:35]
  wire          _T_991 = _T_1125 & d_first_1 & ~d_release_ack;	// @[Decoupled.scala:51:35, Edges.scala:231:25, Monitor.scala:670:46, :671:74, :675:72]
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (_T_1052) begin	// @[Decoupled.scala:51:35]
      ...
      if (_T_1125) begin	// @[Decoupled.scala:51:35]
      ...
      inflight <= (inflight | (_T_976 ? _a_set_T[64:0] : 65'h0)) & ~(_T_991 ? _d_clr_T[64:0] : 65'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_976 ? _a_opcodes_set_T_1[259:0] : 260'h0)) & ~(_T_991 ? _d_opcodes_clr_T_5[259:0] : 260'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :725:35]
      inflight_sizes <= (inflight_sizes | (_T_976 ? _a_sizes_set_T_1[259:0] : 260'h0)) & ~(_T_991 ? _d_sizes_clr_T_5[259:0] : 260'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
      if (_T_1052 | _T_1125)	// @[Decoupled.scala:51:35, Monitor.scala:712:27]
        watchdog <= 32'h0;	// @[Monitor.scala:706:27]
      else	// @[Monitor.scala:712:27]
        watchdog <= watchdog + 32'h1;	// @[Monitor.scala:706:27, :711:26]
    end
    if (_T_1052 & ~(|a_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:229:27, :231:25, Monitor.scala:396:20]
    ...
    if (_T_1125 & ~(|d_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:229:27, :231:25, Monitor.scala:549:20]
