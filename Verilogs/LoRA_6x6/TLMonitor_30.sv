...
module TLMonitor_30(
  ...
  `ifndef SYNTHESIS	// @[Monitor.scala:42:11]
    ...
    wire [259:0]    _GEN_19 = {251'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:634:44]
    wire [259:0]    _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_19;	// @[Monitor.scala:613:35, :634:44]
    ...
    wire [64:0]     _GEN_20 = {58'h0, io_in_d_bits_source};	// @[Monitor.scala:658:26, :682:25]
    wire            _GEN_21 = _T_929 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire            _GEN_22 = _T_929 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    ...
    wire [64:0]     _T_930 = inflight >> _GEN_20;	// @[Monitor.scala:611:27, :682:25]
    wire [259:0]    _a_size_lookup_T_1 = inflight_sizes >> _GEN_19;	// @[Monitor.scala:615:33, :634:44, :638:40]
    wire [127:0]    _d_clr_wo_ready_T = 128'h1 << _GEN_1;	// @[OneHot.scala:57:35]
    wire [64:0]     _T_1016 = 65'h0 >> _GEN_20;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire [259:0]    _c_size_lookup_T_1 = 260'h0 >> _GEN_19;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_5 & ~reset & ~(_WIRE_2_3 & io_in_a_bits_size == 3'h6 & (&(io_in_a_bits_address[27:26])))) begin	// @[Monitor.scala:42:11, :81:{25,54}, :83:78, Parameters.scala:46:9, :91:48, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_7 & ~reset & ~(_WIRE_2_3 & io_in_a_bits_size == 3'h6 & (&(io_in_a_bits_address[27:26])))) begin	// @[Monitor.scala:42:11, :81:25, :92:53, :94:78, Parameters.scala:46:9, :91:48, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~(io_in_a_bits_size != 3'h7 & (&(io_in_a_bits_address[27:26])))) begin	// @[Monitor.scala:42:11, :92:25, :104:45, Parameters.scala:92:42, :137:65, :671:54]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~((~(|(io_in_a_bits_source[6:4])) | io_in_a_bits_source[6:3] == 4'h3 | io_in_a_bits_source[6:3] == 4'h2 | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & io_in_a_bits_size != 3'h7 & (&(io_in_a_bits_address[27:26])))) begin	// @[Monitor.scala:42:11, :92:25, :122:56, :123:74, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:65, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_21 & ~reset & ~(io_in_d_bits_opcode == _GEN_3[io_in_a_bits_opcode] | io_in_d_bits_opcode == _GEN_2[io_in_a_bits_opcode])) begin	// @[Monitor.scala:49:11, :684:30, :685:{38,77}, :686:39]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_22 & ~reset & ~(io_in_d_bits_opcode == _GEN_3[_a_opcode_lookup_T_1[3:1]] | io_in_d_bits_opcode == _GEN_2[_a_opcode_lookup_T_1[3:1]])) begin	// @[Monitor.scala:49:11, :634:44, :684:30, :685:38, :686:39, :689:{38,72}, :690:38]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper opcode response (connected at Plic.scala:363:63)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_GEN_22 & ~reset & io_in_d_bits_size != _a_size_lookup_T_1[3:1]) begin	// @[Monitor.scala:49:11, :638:40, :684:30, :691:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at Plic.scala:363:63)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
  ...
  wire [12:0]   _GEN_23 = {10'h0, io_in_d_bits_size};	// @[package.scala:235:71]
  wire [12:0]   _d_first_beats1_decode_T_1 = 13'h3F << _GEN_23;	// @[package.scala:235:71]
  wire [12:0]   _d_first_beats1_decode_T_5 = 13'h3F << _GEN_23;	// @[package.scala:235:71]
  wire [12:0]   _d_first_beats1_decode_T_9 = 13'h3F << _GEN_23;	// @[package.scala:235:71]
  wire [1026:0] _GEN_24 = {1018'h0, io_in_a_bits_source, 2'h0};	// @[Monitor.scala:656:54]
  wire [1038:0] _GEN_25 = {1030'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:677:76]
  wire [127:0]  _d_clr_T = 128'h1 << _GEN_1;	// @[OneHot.scala:57:35]
  wire [127:0]  _a_set_T = 128'h1 << _GEN_0;	// @[OneHot.scala:57:35]
  wire [1038:0] _d_opcodes_clr_T_5 = 1039'hF << _GEN_25;	// @[Monitor.scala:677:76]
  wire [1026:0] _a_opcodes_set_T_1 = {1023'h0, _T_910 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_24;	// @[Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, Parameters.scala:52:29]
  wire [1038:0] _d_sizes_clr_T_5 = 1039'hF << _GEN_25;	// @[Monitor.scala:677:76, :678:74]
  wire [1026:0] _a_sizes_set_T_1 = {1023'h0, _T_910 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_24;	// @[Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52, Parameters.scala:52:29]
  wire          _T_1059 = io_in_d_ready & io_in_d_valid;	// @[Decoupled.scala:51:35]
  wire          _T_905 = _T_1059 & ~(|d_first_counter);	// @[Decoupled.scala:51:35, Edges.scala:229:27, :231:25, Monitor.scala:549:20]
