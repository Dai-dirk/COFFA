...
module TLXbar_10(
  ...
  wire       _portsAOI_in_0_a_ready_WIRE = requestAIO_0_0 & auto_out_0_a_ready | requestAIO_0_1 & auto_out_1_a_ready;	// @[Mux.scala:27:73, Xbar.scala:366:92]
  ...
  wire       out_9_bits_corrupt = muxStateEarly_0 & auto_out_0_d_bits_corrupt;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  wire       out_9_bits_denied = muxStateEarly_0 & auto_out_0_d_bits_denied;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  ...
  TLMonitor_52 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_d_bits_opcode  ((muxStateEarly_0 ? auto_out_0_d_bits_opcode : 3'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_opcode : 3'h0)),	// @[Arbiter.scala:118:30, Mux.scala:27:73]
    .io_in_d_bits_param   (muxStateEarly_0 ? auto_out_0_d_bits_param : 2'h0),	// @[Arbiter.scala:118:30, Mux.scala:27:73]
    .io_in_d_bits_size    ((muxStateEarly_0 ? auto_out_0_d_bits_size : 2'h0) | {muxStateEarly_1, 1'h0}),	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  ...
  assign auto_in_d_bits_data = (muxStateEarly_0 ? auto_out_0_d_bits_data : 32'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_data : 32'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
