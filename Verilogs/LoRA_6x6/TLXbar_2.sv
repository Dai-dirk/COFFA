...
module TLXbar_2(
  ...
  wire        idle = beatsLeft == 3'h0;	// @[Arbiter.scala:88:30, :89:28, Bundles.scala:259:74]
  ...
  wire        out_9_valid = idle ? _sink_ACancel_earlyValid_T : state_0 & auto_out_0_d_valid | state_1 & auto_out_1_d_valid;	// @[Arbiter.scala:89:28, :108:36, :117:26, :126:29, Mux.scala:27:73]
  wire [6:0]  out_9_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 7'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 7'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  wire [2:0]  out_9_bits_size = (muxStateEarly_0 ? auto_out_0_d_bits_size : 3'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_size : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  wire [2:0]  out_9_bits_opcode = (muxStateEarly_0 ? auto_out_0_d_bits_opcode : 3'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_opcode : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  always @(posedge clock) begin
    if (reset) begin
      beatsLeft <= 3'h0;	// @[Arbiter.scala:88:30, Bundles.scala:259:74]
      ...
      if (latch)	// @[Arbiter.scala:90:24]
        beatsLeft <= (winnerQual_0 & auto_out_0_d_bits_opcode[0] ? ~(_beatsDO_decode_T_1[5:3]) : 3'h0) | (winnerQual_1 & auto_out_1_d_bits_opcode[0] ? ~(_beatsDO_decode_T_5[5:3]) : 3'h0);	// @[Arbiter.scala:88:30, :99:79, :112:73, :113:44, Bundles.scala:259:74, Edges.scala:106:36, :221:14, package.scala:235:{46,71,76}]
      else	// @[Arbiter.scala:90:24]
        beatsLeft <= beatsLeft - {2'h0, auto_in_d_ready & out_9_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, ReadyValidCancel.scala:49:33]
  ...
  TLMonitor_11 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_d_valid        (out_9_valid),	// @[Arbiter.scala:126:29]
  ...
  assign auto_out_1_a_valid = auto_in_a_valid & auto_in_a_bits_address[30];	// @[Parameters.scala:137:45, Xbar.scala:431:50]
  ...
  assign auto_out_0_a_valid = auto_in_a_valid & ~(auto_in_a_bits_address[30]);	// @[Parameters.scala:137:{45,65}, Xbar.scala:431:50]
