...
module TLXbar_8(
  ...
  wire        requestDOI_0_1 = auto_out_d_bits_source == 2'h2;	// @[Parameters.scala:46:9, Xbar.scala:427:24]
  wire        out_8_valid = auto_out_b_valid & ~(auto_out_b_bits_source[1]);	// @[Parameters.scala:54:{10,32}, Xbar.scala:182:40]
  wire        out_10_valid = auto_out_d_valid & ~(auto_out_d_bits_source[1]);	// @[Parameters.scala:54:{10,32}, Xbar.scala:182:40]
  wire        out_13_valid = auto_out_d_valid & requestDOI_0_1;	// @[Parameters.scala:46:9, Xbar.scala:182:40]
  reg  [7:0]  beatsLeft;	// @[Arbiter.scala:88:30]
  wire        idle = beatsLeft == 8'h0;	// @[Arbiter.scala:88:30, :89:28, :112:73, Edges.scala:221:14]
  ...
  wire        portsAOI_filtered_0_ready = auto_out_a_ready & (idle ? readys_readys[0] : state_0);	// @[Arbiter.scala:27:18, :89:28, :96:86, :117:26, :122:24, :124:31]
  wire        portsAOI_filtered_1_0_ready = auto_out_a_ready & (idle ? readys_readys[1] : state_1);	// @[Arbiter.scala:27:18, :89:28, :96:86, :117:26, :122:24, :124:31]
  ...
  always @(posedge clock) begin
    if (reset) begin
      beatsLeft <= 8'h0;	// @[Arbiter.scala:88:30, :112:73, Edges.scala:221:14]
      ...
      if (latch) begin	// @[Arbiter.scala:90:24]
        if (winnerQual_0 & ~(auto_in_0_a_bits_opcode[2]))	// @[Arbiter.scala:99:79, :112:73, Edges.scala:92:{28,37}, :221:14]
          beatsLeft <= ~(_beatsAI_decode_T_1[11:4]);	// @[Arbiter.scala:88:30, package.scala:235:{46,71,76}]
        else	// @[Arbiter.scala:112:73, Edges.scala:221:14]
          beatsLeft <= 8'h0;	// @[Arbiter.scala:88:30, :112:73, Edges.scala:221:14]
      end
      else	// @[Arbiter.scala:90:24]
        beatsLeft <= beatsLeft - {7'h0, auto_out_a_ready & x1_out_1_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, ReadyValidCancel.scala:49:33]
  ...
  TLMonitor_45 monitor (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
    .io_in_a_ready        (portsAOI_filtered_0_ready),	// @[Arbiter.scala:124:31]
    ...
    .io_in_d_valid        (out_10_valid),	// @[Xbar.scala:182:40]
    .io_in_d_bits_opcode  (auto_out_d_bits_opcode),
    .io_in_d_bits_param   (auto_out_d_bits_param),
    .io_in_d_bits_size    (auto_out_d_bits_size),
    .io_in_d_bits_source  (auto_out_d_bits_source[0]),	// @[Xbar.scala:231:69]
  ...
  TLMonitor_46 monitor_1 (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
    .io_in_a_ready        (portsAOI_filtered_1_0_ready),	// @[Arbiter.scala:124:31]
    .io_in_a_valid        (auto_in_1_a_valid),
    .io_in_a_bits_address (auto_in_1_a_bits_address),
    .io_in_d_valid        (out_13_valid),	// @[Xbar.scala:182:40]
    .io_in_d_bits_opcode  (auto_out_d_bits_opcode),
    .io_in_d_bits_param   (auto_out_d_bits_param),
    .io_in_d_bits_size    (auto_out_d_bits_size),
    .io_in_d_bits_sink    (auto_out_d_bits_sink),
  ...
  assign auto_in_1_a_ready = portsAOI_filtered_1_0_ready;	// @[Arbiter.scala:124:31]
  assign auto_in_1_d_valid = out_13_valid;	// @[Xbar.scala:182:40]
  assign auto_in_1_d_bits_opcode = auto_out_d_bits_opcode;
  assign auto_in_1_d_bits_size = auto_out_d_bits_size;
  assign auto_in_1_d_bits_data = auto_out_d_bits_data;
  assign auto_in_1_d_bits_corrupt = auto_out_d_bits_corrupt;
  assign auto_in_0_a_ready = portsAOI_filtered_0_ready;	// @[Arbiter.scala:124:31]
  assign auto_in_0_b_valid = out_8_valid;	// @[Xbar.scala:182:40]
  assign auto_in_0_b_bits_param = auto_out_b_bits_param;
  assign auto_in_0_b_bits_size = auto_out_b_bits_size;
  assign auto_in_0_b_bits_source = auto_out_b_bits_source[0];	// @[Xbar.scala:231:69]
  assign auto_in_0_b_bits_address = auto_out_b_bits_address;
  assign auto_in_0_c_ready = auto_out_c_ready;
  assign auto_in_0_d_valid = out_10_valid;	// @[Xbar.scala:182:40]
  ...
  assign auto_out_a_bits_opcode = (muxStateEarly_0 ? auto_in_0_a_bits_opcode : 3'h0) | {muxStateEarly_1, 2'h0};	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  assign auto_out_a_bits_source = (muxStateEarly_0 ? {1'h0, auto_in_0_a_bits_source} : 2'h0) | {muxStateEarly_1, 1'h0};	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73, Xbar.scala:240:29]
  ...
  assign auto_out_a_bits_mask = (muxStateEarly_0 ? auto_in_0_a_bits_mask : 16'h0) | {16{muxStateEarly_1}};	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_data = muxStateEarly_0 ? auto_in_0_a_bits_data : 128'h0;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  ...
  assign auto_out_c_bits_source = {1'h0, auto_in_0_c_bits_source};	// @[Xbar.scala:262:29]
