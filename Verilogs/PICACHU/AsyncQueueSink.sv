...
module AsyncQueueSink(
  ...
  wire [7:0][31:0] _GEN = {{io_async_mem_7}, {io_async_mem_6}, {io_async_mem_5}, {io_async_mem_4}, {io_async_mem_3}, {io_async_mem_2}, {io_async_mem_1}, {io_async_mem_0}};	// @[SynchronizerReg.scala:209:18]
  ...
  ClockCrossingReg_w32 io_deq_bits_deq_bits_reg (	// @[SynchronizerReg.scala:207:25]
    .clock (clock),
    .io_d  (_GEN[ridx[2:0] ^ {ridx[3], 2'h0}]),	// @[AsyncQueue.scala:54:17, :152:{43,55,62,75}, SynchronizerReg.scala:209:18]
