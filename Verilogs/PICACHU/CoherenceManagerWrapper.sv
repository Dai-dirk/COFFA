...
module CoherenceManagerWrapper(
  ...
  wire [3:0]   _cork_auto_in_d_bits_source;	// @[Configs.scala:105:26]
  ...
  wire [4:0]   _cork_auto_out_a_bits_source;	// @[Configs.scala:105:26]
  ...
  wire [5:0]   _l2_auto_in_d_bits_source;	// @[Configs.scala:76:24]
  wire [3:0]   _l2_auto_in_d_bits_sink;	// @[Configs.scala:76:24]
  wire         _l2_auto_in_d_bits_denied;	// @[Configs.scala:76:24]
  wire [127:0] _l2_auto_in_d_bits_data;	// @[Configs.scala:76:24]
  ...
  wire [3:0]   _l2_auto_out_a_bits_source;	// @[Configs.scala:76:24]
  ...
  wire [2:0]   _l2_auto_out_c_bits_param;	// @[Configs.scala:76:24]
  wire [2:0]   _l2_auto_out_c_bits_size;	// @[Configs.scala:76:24]
  wire [3:0]   _l2_auto_out_c_bits_source;	// @[Configs.scala:76:24]
  ...
  TLCacheCork cork (	// @[Configs.scala:105:26]
    ...
    .auto_in_c_bits_param    (_l2_auto_out_c_bits_param),	// @[Configs.scala:76:24]
