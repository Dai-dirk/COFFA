...
module DebugTransportModuleJTAG(
  ...
  wire        _GEN;	// @[DebugTransport.scala:202:34, :206:26, :208:97, :216:24]
  ...
  wire        _GEN_0 = busy | ~io_dmi_resp_valid;	// @[DebugTransport.scala:155:42, :197:40]
  wire        _T_12 = io_dmi_req_ready & dmiReqValidReg;	// @[DebugTransport.scala:111:31, Decoupled.scala:51:35]
  `ifndef SYNTHESIS	// @[DebugTransport.scala:203:9]
    always @(posedge io_jtag_clock) begin	// @[DebugTransport.scala:203:9]
      if (~io_jtag_reset & _dmiAccessChain_io_update_valid & _GEN & _T_12) begin	// @[DebugTransport.scala:134:31, :202:34, :203:9, :206:26, :208:97, :216:24, Decoupled.scala:51:35]
  ...
  wire        _GEN_1 = stickyBusyReg | _T_11;	// @[DebugTransport.scala:97:30, :111:31, :206:26, :208:{32,97}, :215:22]
  assign _GEN = ~_GEN_1;	// @[DebugTransport.scala:111:31, :202:34, :206:26, :208:97, :215:22, :216:24]
  ...
  wire        _GEN_2 = _tapIO_controllerInternal_io_output_tapIsInTestLogicReset | _dtmInfoChain_io_update_valid & _dtmInfoChain_io_update_bits_dmireset;	// @[DebugTransport.scala:128:29, :163:44, :168:39, :169:49, :170:28, :171:21, :269:45, :271:19, JtagTap.scala:199:36]
  always @(posedge io_jtag_clock or posedge io_jtag_reset) begin
    if (io_jtag_reset) begin
      ...
      stickyBusyReg <= ~_GEN_2 & (_dmiAccessChain_io_capture_capture & _busy_T_1 | stickyBusyReg);	// @[DebugTransport.scala:97:30, :134:31, :155:20, :163:44, :165:19, :168:39, :169:49, :171:21, :269:45, :271:19]
      stickyNonzeroRespReg <= ~_GEN_2 & (_dmiAccessChain_io_capture_capture & _nonzeroResp_T_1 | stickyNonzeroRespReg);	// @[DebugTransport.scala:98:37, :134:31, :163:44, :166:26, :168:39, :169:49, :170:28, :171:21, :178:60, :269:45, :271:19, :272:26]
      ...
      dmiReqValidReg <= ~(_tapIO_controllerInternal_io_output_tapIsInTestLogicReset | _T_12) & (_dmiAccessChain_io_update_valid & ~_GEN_1 | dmiReqValidReg);	// @[DebugTransport.scala:111:31, :134:31, :205:41, :206:26, :208:97, :215:22, :220:28, :221:20, :269:45, :274:20, Decoupled.scala:51:35, JtagTap.scala:199:36]
    end
  ...
  CaptureUpdateChain_1 dmiAccessChain (	// @[DebugTransport.scala:134:31]
    ...
    .io_capture_bits_addr (_GEN_0 ? 7'h0 : dmiReqReg_addr),	// @[DebugTransport.scala:110:23, :182:18, :197:40]
    .io_capture_bits_data (_GEN_0 ? 32'h0 : io_dmi_resp_bits_data),	// @[DebugTransport.scala:184:18, :197:40]
