...
module ICache(
  ...
  wire [7:0]   beats1 = auto_master_out_d_bits_opcode[0] ? ~(_beats1_decode_T_1[11:4]) : 8'h0;	// @[Edges.scala:106:36, :221:14, :229:27, package.scala:235:{46,71,76}]
  reg  [7:0]   counter;	// @[Edges.scala:229:27]
  wire [7:0]   counter1 = counter - 8'h1;	// @[Edges.scala:229:27, :230:28]
  wire [7:0]   refill_cnt = beats1 & ~counter1;	// @[Edges.scala:221:14, :230:28, :234:{25,27}]
  wire         tag_array_MPORT_en = refill_one_beat & (counter == 8'h1 | beats1 == 8'h0) & auto_master_out_d_valid;	// @[Edges.scala:221:14, :229:27, :232:{25,33,43}, ICache.scala:383:41, :391:37]
  ...
  `ifndef SYNTHESIS	// @[ICache.scala:513:9]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (auto_master_out_d_valid) begin
        if (counter == 8'h0) begin	// @[Edges.scala:229:27, :231:25]
  ...
  data_arrays_0_0 data_arrays_0 (	// @[DescribedSRAM.scala:17:26]
    .RW0_addr  (refill_one_beat ? _mem_idx_T_18 | refill_cnt : io_req_bits_addr[11:4]),	// @[Edges.scala:234:25, ICache.scala:383:41, :557:31, :566:{10,40,67}]
