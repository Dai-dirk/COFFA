...
module ListBuffer_2(
  ...
  input  [13:0] io_push_bits_data_tag,
  ...
  output [13:0] io_data_tag,
  output [5:0]  io_data_offset,
                io_data_put
);

  wire [44:0] _data_ext_R0_data;	// @[ListBuffer.scala:51:18]
  wire [4:0]  _next_ext_R0_data;	// @[ListBuffer.scala:50:18]
  wire [4:0]  _tail_ext_R0_data;	// @[ListBuffer.scala:48:18]
  wire [4:0]  _tail_ext_R1_data;	// @[ListBuffer.scala:48:18]
  wire [4:0]  _head_ext_R0_data;	// @[ListBuffer.scala:47:18]
  reg  [35:0] valid;	// @[ListBuffer.scala:46:22]
  reg  [27:0] used;	// @[ListBuffer.scala:49:22]
  wire [27:0] _freeOH_T_19 = ~used;	// @[ListBuffer.scala:49:22, :53:25]
  wire [27:0] _freeOH_T_3 = _freeOH_T_19 | {_freeOH_T_19[26:0], 1'h0};	// @[ListBuffer.scala:53:25, package.scala:245:{43,53}]
  ...
  wire [28:0] freeOH = {~(_freeOH_T_12 | {_freeOH_T_12[11:0], 16'h0}), 1'h1} & {1'h0, _freeOH_T_19};	// @[ListBuffer.scala:53:{16,25,32,38}, package.scala:245:{43,48,53}]
  wire [14:0] _GEN = {3'h0, freeOH[28:17]} | freeOH[15:1];	// @[ListBuffer.scala:53:38, OneHot.scala:31:18, :32:28]
  ...
  wire [4:0]  data_MPORT_addr = {|(freeOH[28:16]), |(_GEN[14:7]), |(_GEN_0[6:3]), |(_GEN_1[2:1]), _GEN_1[2] | _GEN_1[0]};	// @[Cat.scala:33:92, ListBuffer.scala:53:38, OneHot.scala:30:18, :31:18, :32:{14,28}]
  wire [35:0] _push_valid_T = valid >> io_push_bits_index;	// @[ListBuffer.scala:46:22, :62:25]
  wire        _io_push_ready_output = used != 28'hFFFFFFF;	// @[ListBuffer.scala:49:22, :53:25, :64:26]
  ...
  `ifndef SYNTHESIS	// @[ListBuffer.scala:85:10]
    wire [35:0] _T_2 = valid >> io_pop_bits;	// @[ListBuffer.scala:46:22, :85:37]
  ...
  wire [31:0] _used_clr_T = 32'h1 << _head_ext_R0_data;	// @[ListBuffer.scala:47:18, OneHot.scala:64:12]
  always @(posedge clock) begin
    if (reset) begin
      valid <= 36'h0;	// @[ListBuffer.scala:46:22]
      used <= 28'h0;	// @[ListBuffer.scala:49:22]
    end
    else begin
      valid <= valid & ~(io_pop_valid & _head_ext_R0_data == _tail_ext_R0_data ? _valid_clr_T[35:0] : 36'h0) | (data_MPORT_en ? _valid_set_T[35:0] : 36'h0);	// @[Decoupled.scala:51:35, ListBuffer.scala:46:22, :47:18, :48:18, :56:30, :57:30, :65:23, :66:15, :87:22, :89:{20,48}, :90:17, :98:{21,23,35}, OneHot.scala:64:{12,27}]
      used <= used & ~(io_pop_valid ? _used_clr_T[27:0] : 28'h0) | (data_MPORT_en ? freeOH[27:0] : 28'h0);	// @[Decoupled.scala:51:35, ListBuffer.scala:49:22, :53:38, :58:30, :59:30, :65:23, :67:14, :87:22, :88:14, :97:{21,23,35}, OneHot.scala:64:{12,27}]
    end
  end // always @(posedge)
  ...
  assign io_data_source = _data_ext_R0_data[18:13];	// @[ListBuffer.scala:51:18]
  assign io_data_tag = _data_ext_R0_data[32:19];	// @[ListBuffer.scala:51:18]
  assign io_data_offset = _data_ext_R0_data[38:33];	// @[ListBuffer.scala:51:18]
  assign io_data_put = _data_ext_R0_data[44:39];	// @[ListBuffer.scala:51:18]
endmodule
