...
module PeripheryBus(
  ...
  wire [6:0]  _coupler_to_device_named_uart_0_auto_tl_in_d_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [2:0]  _coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_param;	// @[LazyModule.scala:489:27]
  wire [1:0]  _coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_size;	// @[LazyModule.scala:489:27]
  wire [10:0] _coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire        _coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_corrupt;	// @[LazyModule.scala:489:27]
  ...
  wire [6:0]  _coupler_to_bootaddressreg_auto_tl_in_d_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [6:0]  _buffer_1_auto_out_a_bits_source;	// @[Buffer.scala:69:28]
  ...
  wire [2:0]  bundleIn_0_1_d_bits_opcode = {2'h0, out_front_bits_read};	// @[PeripheryBus.scala:50:30, RegisterRouter.scala:72:36, :98:19]
  ...
  TLBuffer buffer (	// @[Buffer.scala:69:28]
    .clock                   (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                   (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  TLInterconnectCoupler_4 coupler_to_bootaddressreg (	// @[LazyModule.scala:489:27]
    ...
    .auto_fragmenter_out_d_bits_opcode  (bundleIn_0_1_d_bits_opcode),	// @[RegisterRouter.scala:98:19]
    ...
    .auto_tl_in_a_bits_param            (_out_xbar_auto_out_0_a_bits_param),	// @[PeripheryBus.scala:50:30]
    ...
    .auto_tl_in_a_bits_corrupt          (_out_xbar_auto_out_0_a_bits_corrupt),	// @[PeripheryBus.scala:50:30]
  ...
  TLMonitor_17 monitor (	// @[Nodes.scala:24:25]
    .clock                (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
    .io_in_a_ready        (_coupler_to_bootaddressreg_auto_fragmenter_out_d_ready),	// @[LazyModule.scala:489:27]
    .io_in_a_valid        (_coupler_to_bootaddressreg_auto_fragmenter_out_a_valid),	// @[LazyModule.scala:489:27]
    .io_in_a_bits_opcode  (_coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_opcode),	// @[LazyModule.scala:489:27]
    .io_in_a_bits_param   (_coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_param),	// @[LazyModule.scala:489:27]
    .io_in_a_bits_size    (_coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_size),	// @[LazyModule.scala:489:27]
    .io_in_a_bits_source  (_coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_source),	// @[LazyModule.scala:489:27]
    .io_in_a_bits_address (_coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_address),	// @[LazyModule.scala:489:27]
    .io_in_a_bits_mask    (_coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_mask),	// @[LazyModule.scala:489:27]
    .io_in_a_bits_corrupt (_coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_corrupt),	// @[LazyModule.scala:489:27]
    .io_in_d_ready        (_coupler_to_bootaddressreg_auto_fragmenter_out_d_ready),	// @[LazyModule.scala:489:27]
    .io_in_d_valid        (_coupler_to_bootaddressreg_auto_fragmenter_out_a_valid),	// @[LazyModule.scala:489:27]
    .io_in_d_bits_opcode  (bundleIn_0_1_d_bits_opcode),	// @[RegisterRouter.scala:98:19]
    .io_in_d_bits_size    (_coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_size),	// @[LazyModule.scala:489:27]
    .io_in_d_bits_source  (_coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_source)	// @[LazyModule.scala:489:27]
  );
