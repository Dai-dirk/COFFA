...
module Queue(
  ...
  wire [119:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_29 ram_ext (	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[15:9];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_address = _ram_ext_R0_data[46:16];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[54:47];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[118:55];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[119];	// @[Decoupled.scala:273:95]
endmodule
