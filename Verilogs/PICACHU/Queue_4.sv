...
module Queue_4(
  ...
  ram_combMem_28 ram_ext (	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_mask = _ram_ext_R0_data[53:46];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[117:54];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[118];	// @[Decoupled.scala:273:95]
endmodule
