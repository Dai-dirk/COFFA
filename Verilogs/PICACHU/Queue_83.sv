...
module Queue_83(
  ...
  wire [145:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_sink = _ram_ext_R0_data[15:12];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_denied = _ram_ext_R0_data[16];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[144:17];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[145];	// @[Decoupled.scala:273:95]
endmodule
