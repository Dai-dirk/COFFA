...
module TLBusBypassBar(
  ...
  wire [1:0] next_flight = flight + {1'h0, done_3 & in_d_bits_opcode[2] & ~(in_d_bits_opcode[1])} + {1'h0, in_a_ready & auto_in_a_valid} - {1'h0, done_3};	// @[Bitwise.scala:51:90, BusBypass.scala:90:28, :98:21, Decoupled.scala:51:35, Edges.scala:71:{36,43,52}, :295:25, :313:37, :324:{30,46}]
