...
module TLFIFOFixer(
  ...
  TLMonitor_5 monitor_1 (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
  ...
  TLMonitor_5 monitor_2 (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
  ...
  TLMonitor_7 monitor_3 (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
    ...
    .io_in_b_bits_size    (auto_out_3_b_bits_size),
