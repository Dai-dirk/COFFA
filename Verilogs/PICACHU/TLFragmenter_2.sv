...
module TLFragmenter_2(
  ...
  wire        _repeater_io_enq_ready;	// @[Fragmenter.scala:264:30]
  ...
  wire [25:0] _repeater_io_deq_bits_address;	// @[Fragmenter.scala:264:30]
  ...
  wire [2:0]  _GEN_0 = {1'h0, _GEN[5:4]} | _GEN[2:0];	// @[Fragmenter.scala:192:24, OneHot.scala:31:18, :32:28, package.scala:233:47]
  ...
  wire        bundleIn_0_d_valid = auto_out_d_valid & ~drop;	// @[Fragmenter.scala:224:30, :226:{36,39}]
  wire [2:0]  bundleIn_0_d_bits_size = dFirst ? dFirst_size : dOrig;	// @[Cat.scala:33:92, Fragmenter.scala:192:24, :195:29, :229:32]
  ...
  `ifndef SYNTHESIS	// @[Fragmenter.scala:311:16]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      dToggle <= 1'h0;	// @[Fragmenter.scala:192:24, :193:30]
  ...
  TLMonitor_29 monitor (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
    .io_in_a_ready        (_repeater_io_enq_ready),	// @[Fragmenter.scala:264:30]
    ...
    .io_in_d_valid        (bundleIn_0_d_valid),	// @[Fragmenter.scala:226:36]
    .io_in_d_bits_opcode  (auto_out_d_bits_opcode),
    .io_in_d_bits_param   (auto_out_d_bits_param),
    .io_in_d_bits_size    (bundleIn_0_d_bits_size),	// @[Fragmenter.scala:229:32]
    .io_in_d_bits_source  (auto_out_d_bits_source[10:4]),	// @[Fragmenter.scala:228:47]
    .io_in_d_bits_sink    (auto_out_d_bits_sink),
    .io_in_d_bits_denied  (auto_out_d_bits_denied),
    .io_in_d_bits_corrupt (auto_out_d_bits_corrupt)
  );
  Repeater_4 repeater (	// @[Fragmenter.scala:264:30]
    .clock               (clock),
    .reset               (reset),
  ...
  assign auto_in_a_ready = _repeater_io_enq_ready;	// @[Fragmenter.scala:264:30]
  assign auto_in_d_valid = bundleIn_0_d_valid;	// @[Fragmenter.scala:226:36]
  assign auto_in_d_bits_opcode = auto_out_d_bits_opcode;
  assign auto_in_d_bits_param = auto_out_d_bits_param;
  assign auto_in_d_bits_size = bundleIn_0_d_bits_size;	// @[Fragmenter.scala:229:32]
  ...
  assign auto_out_a_bits_address = _repeater_io_deq_bits_address | {20'h0, ~(_aOrigOH1_T_1[5:0] | {old_gennum1, ~(_aFragOH1_T_1[2:0])} | 6'h7)};	// @[Fragmenter.scala:264:30, :295:30, :306:{49,51,100,111}, package.scala:235:{46,71,76}]
