...
module TLFragmenter_6(
  ...
  wire [16:0] _repeater_io_deq_bits_address;	// @[Fragmenter.scala:264:30]
  ...
  `ifndef SYNTHESIS	// @[Fragmenter.scala:314:16]
    always @(posedge clock) begin	// @[Fragmenter.scala:314:16]
    ...
    if (reset) begin
      ...
      if (_T_7) begin	// @[Decoupled.scala:51:35]
        if (dFirst)	// @[Fragmenter.scala:195:29]
          ...
          acknum <= acknum - 3'h1;	// @[Fragmenter.scala:191:29, :211:55]
      end
  ...
  Repeater_8 repeater (	// @[Fragmenter.scala:264:30]
    .clock               (clock),
    .reset               (reset),
    .io_repeat           (|old_gennum1),	// @[Fragmenter.scala:295:30, :304:53]
  ...
  assign auto_out_a_bits_address = _repeater_io_deq_bits_address | {11'h0, ~(_aOrigOH1_T_1[5:0] | {old_gennum1, ~(_aFragOH1_T_1[2:0])} | 6'h7)};	// @[Fragmenter.scala:264:30, :295:30, :306:{49,51,100,111}, package.scala:235:{46,71,76}]
