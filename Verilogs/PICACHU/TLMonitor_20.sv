...
module TLMonitor_20(
  ...
  wire          _T_1445 = io_in_a_ready & io_in_a_valid;	// @[Decoupled.scala:51:35]
  ...
  reg  [519:0]  inflight_sizes;	// @[Monitor.scala:615:33]
  ...
  wire          _T_1376 = _T_1445 & a_first_1;	// @[Decoupled.scala:51:35, Edges.scala:231:25, Monitor.scala:652:27]
  ...
  `ifndef SYNTHESIS	// @[Monitor.scala:42:11]
    ...
    wire            _T_472 = io_in_a_bits_size > 4'h2;	// @[Misc.scala:205:21, Parameters.scala:54:32]
    wire            mask_size = io_in_a_bits_size[1:0] == 2'h2;	// @[Misc.scala:208:26, OneHot.scala:63:49, Parameters.scala:54:32]
    wire            mask_acc = _T_472 | mask_size & ~(io_in_a_bits_address[2]);	// @[Misc.scala:205:21, :208:26, :209:26, :210:20, :214:{29,38}]
    wire            mask_acc_1 = _T_472 | mask_size & io_in_a_bits_address[2];	// @[Misc.scala:205:21, :208:26, :209:26, :214:{29,38}]
    ...
    wire [17:0]     _GEN_4 = {io_in_a_bits_address[30:15], io_in_a_bits_address[13:12]};	// @[Parameters.scala:137:45]
    wire [17:0]     _GEN_5 = {io_in_a_bits_address[30:17] ^ 14'h8, io_in_a_bits_address[15:12]};	// @[Parameters.scala:137:{31,45}]
    ...
    wire            _T_536 = io_in_a_bits_size < 4'hD;	// @[Parameters.scala:92:42]
    wire            _GEN_9 = io_in_a_bits_mask != mask;	// @[Cat.scala:33:92, Monitor.scala:110:30]
    wire            _GEN_10 = io_in_a_valid & io_in_a_bits_opcode == 3'h0;	// @[Monitor.scala:114:{25,53}, Parameters.scala:52:29]
    wire            _T_649 = io_in_a_bits_size < 4'hD;	// @[Parameters.scala:92:42]
    wire            _GEN_11 = io_in_a_valid & io_in_a_bits_opcode == 3'h1;	// @[Misc.scala:201:81, Monitor.scala:122:{25,56}]
    wire            _T_761 = io_in_a_bits_size < 4'hD;	// @[Parameters.scala:92:42]
    ...
    wire            _GEN_16 = io_in_d_bits_size < 4'h3;	// @[Monitor.scala:312:27, Parameters.scala:54:32]
    wire            _GEN_17 = io_in_d_valid & io_in_d_bits_opcode == 3'h4;	// @[Monitor.scala:104:25, :318:{25,47}]
    wire            _GEN_18 = io_in_d_bits_param == 2'h2;	// @[Monitor.scala:323:28, Parameters.scala:54:32]
    wire            _GEN_19 = io_in_d_valid & io_in_d_bits_opcode == 3'h5;	// @[Monitor.scala:146:25, :328:{25,51}]
    wire            _GEN_20 = io_in_d_valid & io_in_d_bits_opcode == 3'h0;	// @[Monitor.scala:338:{25,51}, Parameters.scala:52:29]
    ...
    wire            _T_1321 = io_in_a_valid & (|a_first_counter);	// @[Edges.scala:229:27, :231:25, Monitor.scala:389:19]
    wire            _T_1345 = io_in_d_valid & (|d_first_counter);	// @[Edges.scala:229:27, :231:25, Monitor.scala:541:19]
    wire [259:0]    _a_opcode_lookup_T_1 = inflight_opcodes >> {251'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:613:35, :634:44, Parameters.scala:54:32]
    wire [519:0]    _GEN_23 = {510'h0, io_in_d_bits_source, 3'h0};	// @[Monitor.scala:638:40, Parameters.scala:52:29]
    wire            _T_1424 = io_in_d_valid & d_first_1;	// @[Edges.scala:231:25, Monitor.scala:671:26]
    wire            _T_1395 = _T_1424 & ~d_release_ack;	// @[Monitor.scala:670:46, :671:{26,74}, :680:71]
    ...
    wire [64:0]     _GEN_24 = {58'h0, io_in_d_bits_source};	// @[Monitor.scala:658:26, :682:25]
    wire            _GEN_25 = _T_1395 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire            _GEN_26 = _T_1395 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire [7:0]      _GEN_27 = {4'h0, io_in_d_bits_size};	// @[Monitor.scala:691:36, Parameters.scala:52:29]
    wire            _T_1474 = io_in_d_valid & d_first_2 & d_release_ack;	// @[Edges.scala:231:25, Monitor.scala:670:46, :791:71]
    wire [64:0]     _T_1377 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire [64:0]     _T_1396 = inflight >> _GEN_24;	// @[Monitor.scala:611:27, :682:25]
    wire [519:0]    _a_size_lookup_T_1 = inflight_sizes >> _GEN_23;	// @[Monitor.scala:615:33, :638:40]
    wire [64:0]     _T_1475 = 65'h0 >> _GEN_24;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire [519:0]    _c_size_lookup_T_1 = 520'h0 >> _GEN_23;	// @[Monitor.scala:638:40, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_3 & ~reset & ~_T_472) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :81:54]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_3 & ~reset & _GEN_6) begin	// @[Bundles.scala:111:27, Monitor.scala:42:11, :81:54]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_7 & ~reset & ~source_ok) begin	// @[Monitor.scala:42:11, :92:53, Parameters.scala:1126:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
          $error("Assertion failed: 'A' channel AcquirePerm carries invalid source ID (connected at PeripheryBus.scala:54:7)\n    at Monitor.scala:42 assert(cond, message)\n");	// @[Monitor.scala:42:11]
        if (`STOP_COND_)	// @[Monitor.scala:42:11]
          $fatal;	// @[Monitor.scala:42:11]
      end
      if (_GEN_7 & ~reset & ~_T_472) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :92:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
          $error("Assertion failed: 'A' channel AcquirePerm smaller than a beat (connected at PeripheryBus.scala:54:7)\n    at Monitor.scala:42 assert(cond, message)\n");	// @[Monitor.scala:42:11]
        if (`STOP_COND_)	// @[Monitor.scala:42:11]
          $fatal;	// @[Monitor.scala:42:11]
      end
      if (_GEN_7 & ~reset & (|_GEN_2)) begin	// @[Edges.scala:21:{16,24}, Monitor.scala:42:11, :92:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~(_T_536 & (~(|(io_in_a_bits_source[6:4])) | io_in_a_bits_source[6:3] == 4'h3 | io_in_a_bits_source[6:3] == 4'h2 | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6))) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:46:9, :54:{10,32}, :92:42, :1161:30, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
          $error("Assertion failed: 'A' channel carries Get type which master claims it can't emit (connected at PeripheryBus.scala:54:7)\n    at Monitor.scala:42 assert(cond, message)\n");	// @[Monitor.scala:42:11]
        if (`STOP_COND_)	// @[Monitor.scala:42:11]
          $fatal;	// @[Monitor.scala:42:11]
      end
      if (_GEN_8 & ~reset & ~(_T_536 & io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_size < 4'h7 & (_GEN_4 == 18'h0 | io_in_a_bits_address[30:16] == 15'h1 | _GEN_5 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :104:45, :706:27, Parameters.scala:92:42, :137:{31,45,65}, :671:54, :672:42, :673:26]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~source_ok) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:1126:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
          $error("Assertion failed: 'A' channel Get carries invalid source ID (connected at PeripheryBus.scala:54:7)\n    at Monitor.scala:42 assert(cond, message)\n");	// @[Monitor.scala:42:11]
        if (`STOP_COND_)	// @[Monitor.scala:42:11]
          $fatal;	// @[Monitor.scala:42:11]
      end
      if (_GEN_8 & ~reset & (|_GEN_2)) begin	// @[Edges.scala:21:{16,24}, Monitor.scala:42:11, :104:45]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(_T_649 & (~(|(io_in_a_bits_source[6:4])) | io_in_a_bits_source[6:3] == 4'h3 | io_in_a_bits_source[6:3] == 4'h2 | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & (_T_649 & io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_size < 4'h7 & (_GEN_4 == 18'h0 | _GEN_5 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000)))) begin	// @[Monitor.scala:42:11, :114:53, :115:71, :706:27, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,45,65}, :671:54, :672:42, :673:26, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~source_ok) begin	// @[Monitor.scala:42:11, :114:53, Parameters.scala:1126:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(_T_761 & (~(|(io_in_a_bits_source[6:4])) | io_in_a_bits_source[6:3] == 4'h3 | io_in_a_bits_source[6:3] == 4'h2 | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & (_T_761 & io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_size < 4'h7 & (_GEN_4 == 18'h0 | _GEN_5 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000)))) begin	// @[Monitor.scala:42:11, :122:56, :123:74, :706:27, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,45,65}, :671:54, :672:42, :673:26, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~source_ok) begin	// @[Monitor.scala:42:11, :122:56, Parameters.scala:1126:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_12 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(|(io_in_a_bits_source[6:4])) | io_in_a_bits_source[6:3] == 4'h3 | io_in_a_bits_source[6:3] == 4'h2 | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & io_in_a_bits_size < 4'h4 & (io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :130:56, :131:74, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,65}, :672:42, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_12 & ~reset & ~source_ok) begin	// @[Monitor.scala:42:11, :130:56, Parameters.scala:1126:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(|(io_in_a_bits_source[6:4])) | io_in_a_bits_source[6:3] == 4'h3 | io_in_a_bits_source[6:3] == 4'h2 | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & io_in_a_bits_size < 4'h4 & (io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :138:53, :139:71, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,65}, :672:42, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~source_ok) begin	// @[Monitor.scala:42:11, :138:53, Parameters.scala:1126:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(|(io_in_a_bits_source[6:4])) | io_in_a_bits_source[6:3] == 4'h3 | io_in_a_bits_source[6:3] == 4'h2 | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & io_in_a_bits_address[30:12] == 19'h3)) begin	// @[Monitor.scala:42:11, :146:46, :147:68, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,65}, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~source_ok) begin	// @[Monitor.scala:42:11, :146:46, Parameters.scala:1126:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_15 & ~reset & ~source_ok_1) begin	// @[Monitor.scala:49:11, :310:52, Parameters.scala:1126:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_17 & ~reset & ~source_ok_1) begin	// @[Monitor.scala:49:11, :318:47, Parameters.scala:1126:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_19 & ~reset & ~source_ok_1) begin	// @[Monitor.scala:49:11, :328:51, Parameters.scala:1126:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_20 & ~reset & ~source_ok_1) begin	// @[Monitor.scala:49:11, :338:51, Parameters.scala:1126:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_21 & ~reset & ~source_ok_1) begin	// @[Monitor.scala:49:11, :346:55, Parameters.scala:1126:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_22 & ~reset & ~source_ok_1) begin	// @[Monitor.scala:49:11, :354:49, Parameters.scala:1126:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_26 & ~reset & ~(io_in_d_bits_opcode == _GEN_1[_a_opcode_lookup_T_1[3:1]] | io_in_d_bits_opcode == _GEN_0[_a_opcode_lookup_T_1[3:1]])) begin	// @[Monitor.scala:49:11, :634:44, :684:30, :685:38, :686:39, :689:{38,72}, :690:38]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper opcode response (connected at PeripheryBus.scala:54:7)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_GEN_26 & ~reset & _GEN_27 != {1'h0, _a_size_lookup_T_1[7:1]}) begin	// @[Monitor.scala:42:11, :49:11, :638:{19,40}, :684:30, :691:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at PeripheryBus.scala:54:7)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_T_1424 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin	// @[Edges.scala:231:25, Monitor.scala:49:11, :670:46, :671:{26,74}, :694:90, :695:{15,32}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_T_1474 & ~reset & ~(_T_1475[0])) begin	// @[Monitor.scala:49:11, :791:71, :793:25]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at PeripheryBus.scala:54:7)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_T_1474 & ~reset & _GEN_27 != {1'h0, _c_size_lookup_T_1[7:1]}) begin	// @[Monitor.scala:42:11, :49:11, :691:36, :747:{21,42}, :791:71, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at PeripheryBus.scala:54:7)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
  ...
  wire [26:0]   _GEN_28 = {23'h0, io_in_d_bits_size};	// @[package.scala:235:71]
  wire [26:0]   _d_first_beats1_decode_T_1 = 27'hFFF << _GEN_28;	// @[package.scala:235:71]
  wire [26:0]   _d_first_beats1_decode_T_5 = 27'hFFF << _GEN_28;	// @[package.scala:235:71]
  wire [26:0]   _d_first_beats1_decode_T_9 = 27'hFFF << _GEN_28;	// @[package.scala:235:71]
  ...
  wire [1038:0] _d_opcodes_clr_T_5 = 1039'hF << {1030'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:677:76, Parameters.scala:54:32]
  wire [1026:0] _a_opcodes_set_T_1 = {1023'h0, _T_1376 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {1018'h0, io_in_a_bits_source, 2'h0};	// @[Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, :657:52, Parameters.scala:52:29, :54:32]
  wire [1038:0] _d_sizes_clr_T_5 = 1039'hFF << {1029'h0, io_in_d_bits_source, 3'h0};	// @[Monitor.scala:677:76, :678:74, Parameters.scala:52:29]
  wire [1027:0] _a_sizes_set_T_1 = {1023'h0, _T_1376 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {1018'h0, io_in_a_bits_source, 3'h0};	// @[Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52, Parameters.scala:52:29]
  wire          _T_1513 = io_in_d_ready & io_in_d_valid;	// @[Decoupled.scala:51:35]
  wire          _T_1391 = _T_1513 & d_first_1 & ~d_release_ack;	// @[Decoupled.scala:51:35, Edges.scala:231:25, Monitor.scala:670:46, :671:74, :675:72]
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight_opcodes <= 260'h0;	// @[Monitor.scala:613:35, :724:35]
      inflight_sizes <= 520'h0;	// @[Monitor.scala:615:33, :725:35]
      ...
      if (_T_1445) begin	// @[Decoupled.scala:51:35]
      ...
      if (_T_1513) begin	// @[Decoupled.scala:51:35]
      ...
      inflight <= (inflight | (_T_1376 ? _a_set_T[64:0] : 65'h0)) & ~(_T_1391 ? _d_clr_T[64:0] : 65'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_1376 ? _a_opcodes_set_T_1[259:0] : 260'h0)) & ~(_T_1391 ? _d_opcodes_clr_T_5[259:0] : 260'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :724:35]
      inflight_sizes <= (inflight_sizes | (_T_1376 ? _a_sizes_set_T_1[519:0] : 520'h0)) & ~(_T_1391 ? _d_sizes_clr_T_5[519:0] : 520'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
      if (_T_1445 | _T_1513)	// @[Decoupled.scala:51:35, Monitor.scala:712:27]
        watchdog <= 32'h0;	// @[Monitor.scala:706:27]
      else	// @[Monitor.scala:712:27]
        watchdog <= watchdog + 32'h1;	// @[Monitor.scala:706:27, :711:26]
    end
    if (_T_1445 & ~(|a_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:229:27, :231:25, Monitor.scala:396:20]
    ...
    if (_T_1513 & ~(|d_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:229:27, :231:25, Monitor.scala:549:20]
