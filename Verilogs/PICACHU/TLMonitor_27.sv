...
module TLMonitor_27(
  ...
  wire          _T_995 = io_in_a_ready & io_in_a_valid;	// @[Decoupled.scala:51:35]
  ...
  wire          _T_919 = _T_995 & a_first_1;	// @[Decoupled.scala:51:35, Edges.scala:231:25, Monitor.scala:652:27]
  ...
  `ifndef SYNTHESIS	// @[Monitor.scala:42:11]
    ...
    wire            _T_304 = io_in_a_bits_size > 4'h2;	// @[Misc.scala:205:21, Parameters.scala:54:32]
    ...
    wire            _T_368 = io_in_a_bits_size < 4'hD;	// @[Parameters.scala:92:42]
    ...
    wire            _T_864 = io_in_a_valid & (|a_first_counter);	// @[Edges.scala:229:27, :231:25, Monitor.scala:389:19]
    wire            _T_888 = io_in_d_valid & (|d_first_counter);	// @[Edges.scala:229:27, :231:25, Monitor.scala:541:19]
    ...
    wire            _T_967 = io_in_d_valid & d_first_1;	// @[Edges.scala:231:25, Monitor.scala:671:26]
    wire            _T_938 = _T_967 & ~d_release_ack;	// @[Monitor.scala:670:46, :671:{26,74}, :680:71]
    ...
    wire            _GEN_25 = _T_938 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire            _GEN_26 = _T_938 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire [7:0]      _GEN_27 = {4'h0, io_in_d_bits_size};	// @[Monitor.scala:691:36, Parameters.scala:52:29]
    wire            _T_1024 = io_in_d_valid & d_first_2 & d_release_ack;	// @[Edges.scala:231:25, Monitor.scala:670:46, :791:71]
    wire [64:0]     _T_920 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire [64:0]     _T_939 = inflight >> _GEN_24;	// @[Monitor.scala:611:27, :682:25]
    ...
    wire [64:0]     _T_1025 = 65'h0 >> _GEN_24;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_5 & ~reset & ~(_WIRE_2_3 & io_in_a_bits_size == 4'h6 & io_in_a_bits_size < 4'hD & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :81:54, :83:78, Parameters.scala:46:9, :91:48, :92:42, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_7 & ~reset & ~(_WIRE_2_3 & io_in_a_bits_size == 4'h6 & io_in_a_bits_size < 4'hD & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :92:53, :94:78, Parameters.scala:46:9, :91:48, :92:42, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_7 & ~reset & ~_T_304) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :92:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~(_T_368 & (~(|(io_in_a_bits_source[6:4])) | io_in_a_bits_source[6:3] == 4'h3 | io_in_a_bits_source[6:3] == 4'h2 | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6))) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:46:9, :54:{10,32}, :92:42, :1161:30, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~(_T_368 & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:92:42, :137:65, :671:54]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(|(io_in_a_bits_source[6:4])) | io_in_a_bits_source[6:3] == 4'h3 | io_in_a_bits_source[6:3] == 4'h2 | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :114:53, :115:71, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:65, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(|(io_in_a_bits_source[6:4])) | io_in_a_bits_source[6:3] == 4'h3 | io_in_a_bits_source[6:3] == 4'h2 | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :122:56, :123:74, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:65, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_12 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(|(io_in_a_bits_source[6:4])) | io_in_a_bits_source[6:3] == 4'h3 | io_in_a_bits_source[6:3] == 4'h2 | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & io_in_a_bits_size < 4'h4 & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :130:56, :131:74, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:65, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(|(io_in_a_bits_source[6:4])) | io_in_a_bits_source[6:3] == 4'h3 | io_in_a_bits_source[6:3] == 4'h2 | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & io_in_a_bits_size < 4'h4 & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :138:53, :139:71, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:65, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(|(io_in_a_bits_source[6:4])) | io_in_a_bits_source[6:3] == 4'h3 | io_in_a_bits_source[6:3] == 4'h2 | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :146:46, :147:68, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:65, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_967 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin	// @[Edges.scala:231:25, Monitor.scala:49:11, :670:46, :671:{26,74}, :694:90, :695:{15,32}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(a_set_wo_ready != (_T_967 & ~d_release_ack ? _d_clr_wo_ready_T[64:0] : 65'h0) | a_set_wo_ready == 65'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_T_1024 & ~reset & ~(_T_1025[0])) begin	// @[Monitor.scala:49:11, :791:71, :793:25]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at CanHaveBuiltInDevices.scala:44:9)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_T_1024 & ~reset & _GEN_27 != {1'h0, _c_size_lookup_T_1[7:1]}) begin	// @[Monitor.scala:42:11, :49:11, :691:36, :747:{21,42}, :791:71, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at CanHaveBuiltInDevices.scala:44:9)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
  ...
  wire [1026:0] _a_opcodes_set_T_1 = {1023'h0, _T_919 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {1018'h0, io_in_a_bits_source, 2'h0};	// @[Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, :657:52, Parameters.scala:52:29, :54:32]
  ...
  wire [1027:0] _a_sizes_set_T_1 = {1023'h0, _T_919 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {1018'h0, io_in_a_bits_source, 3'h0};	// @[Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52, Parameters.scala:52:29]
  wire          _T_1068 = io_in_d_ready & io_in_d_valid;	// @[Decoupled.scala:51:35]
  wire          _T_934 = _T_1068 & d_first_1 & ~d_release_ack;	// @[Decoupled.scala:51:35, Edges.scala:231:25, Monitor.scala:670:46, :671:74, :675:72]
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (_T_995) begin	// @[Decoupled.scala:51:35]
      ...
      if (_T_1068) begin	// @[Decoupled.scala:51:35]
      ...
      inflight <= (inflight | (_T_919 ? _a_set_T[64:0] : 65'h0)) & ~(_T_934 ? _d_clr_T[64:0] : 65'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_919 ? _a_opcodes_set_T_1[259:0] : 260'h0)) & ~(_T_934 ? _d_opcodes_clr_T_5[259:0] : 260'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :724:35]
      inflight_sizes <= (inflight_sizes | (_T_919 ? _a_sizes_set_T_1[519:0] : 520'h0)) & ~(_T_934 ? _d_sizes_clr_T_5[519:0] : 520'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
      if (_T_995 | _T_1068)	// @[Decoupled.scala:51:35, Monitor.scala:712:27]
        watchdog <= 32'h0;	// @[Monitor.scala:706:27]
      else	// @[Monitor.scala:712:27]
        watchdog <= watchdog + 32'h1;	// @[Monitor.scala:706:27, :711:26]
    end
    if (_T_995 & ~(|a_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:229:27, :231:25, Monitor.scala:396:20]
    ...
    if (_T_1068 & ~(|d_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:229:27, :231:25, Monitor.scala:549:20]
