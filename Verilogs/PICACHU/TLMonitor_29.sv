...
module TLMonitor_29(
  ...
  `ifndef SYNTHESIS	// @[Monitor.scala:42:11]
    ...
    wire            _GEN_25 = _T_929 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    ...
    wire [64:0]     _T_930 = inflight >> _GEN_24;	// @[Monitor.scala:611:27, :682:25]
    ...
    wire [64:0]     _T_1016 = 65'h0 >> _GEN_24;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_5 & ~reset & ~(_WIRE_2_3 & io_in_a_bits_size == 3'h6 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :81:{25,54}, :83:78, Parameters.scala:46:9, :91:48, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_7 & ~reset & ~(_WIRE_2_3 & io_in_a_bits_size == 3'h6 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :81:25, :92:53, :94:78, Parameters.scala:46:9, :91:48, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~(io_in_a_bits_size != 3'h7 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :92:25, :104:45, Parameters.scala:92:42, :137:{31,65}, :671:54]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~((~(|(io_in_a_bits_source[6:4])) | io_in_a_bits_source[6:3] == 4'h3 | io_in_a_bits_source[6:3] == 4'h2 | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & io_in_a_bits_size != 3'h7 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :92:25, :122:56, :123:74, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,65}, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
  ...
  wire [1026:0] _a_opcodes_set_T_1 = {1023'h0, _T_910 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_28;	// @[Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, Parameters.scala:52:29]
  wire [1038:0] _d_sizes_clr_T_5 = 1039'hF << _GEN_29;	// @[Monitor.scala:677:76, :678:74]
  wire [1026:0] _a_sizes_set_T_1 = {1023'h0, _T_910 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_28;	// @[Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52, Parameters.scala:52:29]
