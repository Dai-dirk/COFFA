...
module TLMonitor_47(
  ...
  `ifndef SYNTHESIS	// @[Monitor.scala:42:11]
    ...
    wire            _GEN_11 = io_in_a_valid & io_in_a_bits_opcode == 3'h0;	// @[Monitor.scala:114:{25,53}]
    ...
    wire            _GEN_14 = io_in_a_valid & io_in_a_bits_opcode == 3'h3;	// @[Monitor.scala:138:{25,53}]
    ...
    wire            _GEN_21 = io_in_d_valid & io_in_d_bits_opcode == 3'h0;	// @[Monitor.scala:338:{25,51}]
    ...
    wire [63:0]     _GEN_24 = {58'h0, io_in_d_bits_source, 3'h0};	// @[Monitor.scala:638:40]
    ...
    wire            _GEN_25 = _T_1152 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire            _GEN_26 = _T_1152 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire [7:0]      _GEN_27 = {4'h0, io_in_d_bits_size};	// @[Misc.scala:201:34, Monitor.scala:691:36]
    ...
    wire [63:0]     _a_size_lookup_T_1 = inflight_sizes >> _GEN_24;	// @[Monitor.scala:615:33, :638:40]
    wire [7:0]      _T_1239 = 8'h0 >> _GEN_1;	// @[Monitor.scala:723:35, :793:25, OneHot.scala:57:35]
    wire [63:0]     _c_size_lookup_T_1 = 64'h0 >> _GEN_24;	// @[Monitor.scala:638:40, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_6 & ~reset & ~(io_in_a_bits_size < 4'hD & io_in_a_bits_size == 4'h6 & io_in_a_bits_address[31:28] == 4'h8)) begin	// @[Monitor.scala:42:11, :92:53, :93:72, Parameters.scala:91:48, :92:42, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_6 & ~reset & (|_GEN_4)) begin	// @[Edges.scala:21:{16,24}, Monitor.scala:42:11, :92:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_7 & ~reset & ~_T_364) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:92:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_7 & ~reset & ~(_T_364 & io_in_a_bits_address[31:12] == 20'h3 | io_in_a_bits_size < 4'h7 & (_GEN_8 == 19'h0 | io_in_a_bits_address[31:16] == 16'h1 | _GEN_9 == 19'h0 | io_in_a_bits_address[31:16] == 16'h200 | io_in_a_bits_address[31:12] == 20'h2010 | io_in_a_bits_address[31:26] == 6'h3 | io_in_a_bits_address[31:12] == 20'h54000 | io_in_a_bits_address[31:28] == 4'h8))) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:92:42, :137:{31,45,65}, :671:54, :672:42, :673:26]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_7 & ~reset & (|_GEN_4)) begin	// @[Edges.scala:21:{16,24}, Monitor.scala:42:11, :104:45]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(_T_461 & (_T_461 & io_in_a_bits_address[31:12] == 20'h3 | io_in_a_bits_size < 4'h7 & (_GEN_8 == 19'h0 | _GEN_9 == 19'h0 | io_in_a_bits_address[31:16] == 16'h200 | io_in_a_bits_address[31:12] == 20'h2010 | io_in_a_bits_address[31:26] == 6'h3 | io_in_a_bits_address[31:12] == 20'h54000 | io_in_a_bits_address[31:28] == 4'h8)))) begin	// @[Monitor.scala:42:11, :114:53, :115:71, Parameters.scala:92:42, :137:{31,45,65}, :671:54, :672:42, :673:26]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_12 & ~reset & ~(_T_557 & (_T_557 & io_in_a_bits_address[31:12] == 20'h3 | io_in_a_bits_size < 4'h7 & (_GEN_8 == 19'h0 | _GEN_9 == 19'h0 | io_in_a_bits_address[31:16] == 16'h200 | io_in_a_bits_address[31:12] == 20'h2010 | io_in_a_bits_address[31:26] == 6'h3 | io_in_a_bits_address[31:12] == 20'h54000 | io_in_a_bits_address[31:28] == 4'h8)))) begin	// @[Monitor.scala:42:11, :122:56, :123:74, Parameters.scala:92:42, :137:{31,45,65}, :671:54, :672:42, :673:26]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~(io_in_a_bits_size < 4'hD & (io_in_a_bits_size < 4'h4 & (_GEN_8 == 19'h0 | io_in_a_bits_address[31:12] == 20'h3 | _GEN_9 == 19'h0 | io_in_a_bits_address[31:16] == 16'h200 | io_in_a_bits_address[31:12] == 20'h2010 | io_in_a_bits_address[31:26] == 6'h3 | io_in_a_bits_address[31:12] == 20'h54000) | io_in_a_bits_size < 4'h5 & io_in_a_bits_address[31:28] == 4'h8))) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :130:56, :131:74, Parameters.scala:92:42, :137:{31,45,65}, :671:54, :672:42, :673:26]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(io_in_a_bits_size < 4'hD & (io_in_a_bits_size < 4'h4 & (_GEN_8 == 19'h0 | io_in_a_bits_address[31:12] == 20'h3 | _GEN_9 == 19'h0 | io_in_a_bits_address[31:16] == 16'h200 | io_in_a_bits_address[31:12] == 20'h2010 | io_in_a_bits_address[31:26] == 6'h3 | io_in_a_bits_address[31:12] == 20'h54000) | io_in_a_bits_size < 4'h5 & io_in_a_bits_address[31:28] == 4'h8))) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :138:53, :139:71, Parameters.scala:92:42, :137:{31,45,65}, :671:54, :672:42, :673:26]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_15 & ~reset & ~(_T_847 & (_T_847 & io_in_a_bits_address[31:12] == 20'h3 | io_in_a_bits_size < 4'h7 & io_in_a_bits_address[31:28] == 4'h8))) begin	// @[Monitor.scala:42:11, :146:46, :147:68, Parameters.scala:92:42, :137:{31,65}, :671:54, :673:26]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_1078 & ~reset & (|param)) begin	// @[Monitor.scala:42:11, :385:22, :389:19, :391:32]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_26 & ~reset & _GEN_27 != {1'h0, _a_size_lookup_T_1[7:1]}) begin	// @[Monitor.scala:49:11, :638:{19,40}, :684:30, :691:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at CrossingHelper.scala:61:80)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      ...
      if (_T_1238 & ~reset & _GEN_27 != {1'h0, _c_size_lookup_T_1[7:1]}) begin	// @[Monitor.scala:49:11, :691:36, :747:{21,42}, :791:71, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at CrossingHelper.scala:61:80)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
  ...
  wire [78:0] _d_sizes_clr_T_5 = 79'hFF << {73'h0, io_in_d_bits_source, 3'h0};	// @[Monitor.scala:677:76, :678:74]
  wire [67:0] _a_sizes_set_T_1 = {63'h0, _T_1133 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {62'h0, io_in_a_bits_source, 3'h0};	// @[Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
