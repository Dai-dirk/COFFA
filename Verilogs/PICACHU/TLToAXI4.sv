...
module TLToAXI4(
  ...
  wire [31:0][4:0] _GEN = '{5'h0, 5'h0, 5'h0, 5'h0, 5'h0, 5'h0, 5'h0, 5'h0, 5'h0, 5'h0, 5'h0, 5'h0, 5'h13, 5'h12, 5'h11, 5'h10, 5'hF, 5'hE, 5'hD, 5'hC, 5'hB, 5'hA, 5'h9, 5'h8, 5'h7, 5'h6, 5'h5, 5'h4, 5'h3, 5'h2, 5'h1, 5'h0};	// @[ToAXI4.scala:169:17]
  wire [12:0]      _beats1_decode_T_1 = 13'h3F << auto_in_a_bits_size;	// @[package.scala:235:71]
  reg  [2:0]       counter;	// @[Edges.scala:229:27]
  wire             a_first = counter == 3'h0;	// @[Edges.scala:229:27, :231:25]
  wire             out_w_bits_last = counter == 3'h1 | (auto_in_a_bits_opcode[2] ? 3'h0 : ~(_beats1_decode_T_1[5:3])) == 3'h0;	// @[Edges.scala:92:37, :221:14, :229:27, :232:{25,33,43}, ToAXI4.scala:176:17, package.scala:235:{46,71,76}]
  ...
  wire [2:0]       bundleIn_0_d_bits_opcode = {2'h0, r_wins};	// @[Edges.scala:232:25, ToAXI4.scala:218:53, :240:23]
  wire [2:0]       bundleIn_0_d_bits_size = r_wins ? auto_out_r_bits_echo_tl_state_size[2:0] : auto_out_b_bits_echo_tl_state_size[2:0];	// @[Edges.scala:773:15, :789:15, ToAXI4.scala:218:53, :240:23]
  wire [4:0]       bundleIn_0_d_bits_source = r_wins ? auto_out_r_bits_echo_tl_state_source : auto_out_b_bits_echo_tl_state_source;	// @[ToAXI4.scala:218:53, :240:23]
  wire             bundleIn_0_d_bits_denied = r_wins ? r_d_denied : (|auto_out_b_bits_resp);	// @[ToAXI4.scala:218:53, :231:39, :240:23, package.scala:80:42]
  wire             bundleIn_0_d_bits_corrupt = r_wins & ((|auto_out_r_bits_resp) | r_d_denied);	// @[ToAXI4.scala:218:53, :230:39, :233:96, :240:23, package.scala:80:42]
  ...
  wire             _inc_T_19 = _queue_arw_deq_io_enq_ready & out_arw_valid;	// @[Decoupled.scala:51:35, :375:21, ToAXI4.scala:200:45]
  wire             inc = out_arw_bits_id == 5'h0 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             _dec_T_39 = auto_in_d_ready & bundleIn_0_d_valid;	// @[Decoupled.scala:51:35, ToAXI4.scala:222:24]
  wire             dec = d_sel_shiftAmount == 5'h0 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire             inc_1 = out_arw_bits_id == 5'h1 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             dec_1 = d_sel_shiftAmount == 5'h1 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire             inc_2 = out_arw_bits_id == 5'h2 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             dec_2 = d_sel_shiftAmount == 5'h2 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire             inc_3 = out_arw_bits_id == 5'h3 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             dec_3 = d_sel_shiftAmount == 5'h3 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire             inc_4 = out_arw_bits_id == 5'h4 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             dec_4 = d_sel_shiftAmount == 5'h4 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire             inc_5 = out_arw_bits_id == 5'h5 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             dec_5 = d_sel_shiftAmount == 5'h5 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire             inc_6 = out_arw_bits_id == 5'h6 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             dec_6 = d_sel_shiftAmount == 5'h6 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire             inc_7 = out_arw_bits_id == 5'h7 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             dec_7 = d_sel_shiftAmount == 5'h7 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire             inc_8 = out_arw_bits_id == 5'h8 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             dec_8 = d_sel_shiftAmount == 5'h8 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire             inc_9 = out_arw_bits_id == 5'h9 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             dec_9 = d_sel_shiftAmount == 5'h9 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire             inc_10 = out_arw_bits_id == 5'hA & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             dec_10 = d_sel_shiftAmount == 5'hA & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire             inc_11 = out_arw_bits_id == 5'hB & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             dec_11 = d_sel_shiftAmount == 5'hB & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire             inc_12 = out_arw_bits_id == 5'hC & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             dec_12 = d_sel_shiftAmount == 5'hC & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire             inc_13 = out_arw_bits_id == 5'hD & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             dec_13 = d_sel_shiftAmount == 5'hD & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire             inc_14 = out_arw_bits_id == 5'hE & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             dec_14 = d_sel_shiftAmount == 5'hE & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire             inc_15 = out_arw_bits_id == 5'hF & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             dec_15 = d_sel_shiftAmount == 5'hF & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire             inc_16 = out_arw_bits_id == 5'h10 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             dec_16 = d_sel_shiftAmount == 5'h10 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire             inc_17 = out_arw_bits_id == 5'h11 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             dec_17 = d_sel_shiftAmount == 5'h11 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire             inc_18 = out_arw_bits_id == 5'h12 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             dec_18 = d_sel_shiftAmount == 5'h12 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire             inc_19 = out_arw_bits_id == 5'h13 & _inc_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             dec_19 = d_sel_shiftAmount == 5'h13 & d_last & _dec_T_39;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  `ifndef SYNTHESIS	// @[ToAXI4.scala:265:16]
  ...
  always @(posedge clock) begin
    ...
    if (auto_out_b_valid & ~x1_b_ready)	// @[ToAXI4.scala:213:{25,28}, :221:33]
      ...
      b_delay <= 3'h0;	// @[Edges.scala:229:27, ToAXI4.scala:212:24]
  ...
  TLMonitor_39 monitor (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
    .io_in_a_ready        (bundleIn_0_a_ready),	// @[ToAXI4.scala:199:28]
    ...
    .io_in_d_valid        (bundleIn_0_d_valid),	// @[ToAXI4.scala:222:24]
    .io_in_d_bits_opcode  (bundleIn_0_d_bits_opcode),	// @[ToAXI4.scala:240:23]
    .io_in_d_bits_size    (bundleIn_0_d_bits_size),	// @[ToAXI4.scala:240:23]
    .io_in_d_bits_source  (bundleIn_0_d_bits_source),	// @[ToAXI4.scala:240:23]
    .io_in_d_bits_denied  (bundleIn_0_d_bits_denied),	// @[ToAXI4.scala:240:23]
    .io_in_d_bits_corrupt (bundleIn_0_d_bits_corrupt)	// @[ToAXI4.scala:240:23]
  );
  Queue_49 deq (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
  ...
  Queue_50 queue_arw_deq (	// @[Decoupled.scala:375:21]
    .clock                            (clock),
    .reset                            (reset),
    ...
    .io_enq_bits_size                 (auto_in_a_bits_size > 3'h2 ? 3'h3 : auto_in_a_bits_size),	// @[ToAXI4.scala:172:{23,31}]
  ...
  assign auto_in_d_bits_opcode = bundleIn_0_d_bits_opcode;	// @[ToAXI4.scala:240:23]
  assign auto_in_d_bits_size = bundleIn_0_d_bits_size;	// @[ToAXI4.scala:240:23]
  assign auto_in_d_bits_source = bundleIn_0_d_bits_source;	// @[ToAXI4.scala:240:23]
  assign auto_in_d_bits_denied = bundleIn_0_d_bits_denied;	// @[ToAXI4.scala:240:23]
  assign auto_in_d_bits_data = auto_out_r_bits_data;
  assign auto_in_d_bits_corrupt = bundleIn_0_d_bits_corrupt;	// @[ToAXI4.scala:240:23]
