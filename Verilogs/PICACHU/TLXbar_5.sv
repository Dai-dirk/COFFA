...
module TLXbar_5(
  ...
  wire        requestAIO_0_2 = {auto_in_a_bits_address[30], auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13] ^ 2'h2} == 7'h0 | {_GEN_0[5], _GEN_0[1:0], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13]} == 7'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{31,45,65}, Xbar.scala:366:92]
  ...
  wire        requestAIO_0_7 = {auto_in_a_bits_address[30], auto_in_a_bits_address[26:25], ~(auto_in_a_bits_address[20]), auto_in_a_bits_address[14:13]} == 6'h0;	// @[Arbiter.scala:113:44, Parameters.scala:137:{31,45,65}]
  ...
  wire [6:0]  _GEN_1 = _readys_filter_T_1[6:0] | _readys_filter_T_1[7:1];	// @[Arbiter.scala:25:28, package.scala:254:43]
  wire        _GEN_2 = auto_out_7_d_valid | _readys_filter_T_1[0];	// @[Arbiter.scala:25:28, package.scala:254:43]
  ...
  wire        _GEN_7 = _GEN_1[5] | _readys_filter_T_1[7];	// @[Arbiter.scala:25:28, package.scala:254:43]
  ...
  wire        out_27_bits_corrupt = muxStateEarly_0 & auto_out_0_d_bits_corrupt | muxStateEarly_1 & auto_out_1_d_bits_corrupt | muxStateEarly_2 & auto_out_2_d_bits_corrupt | muxStateEarly_7 & auto_out_7_d_bits_corrupt;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  wire        out_27_bits_denied = muxStateEarly_0 & auto_out_0_d_bits_denied | muxStateEarly_1 & auto_out_1_d_bits_denied | muxStateEarly_2 & auto_out_2_d_bits_denied | muxStateEarly_7 & auto_out_7_d_bits_denied;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  wire        out_27_bits_sink = muxStateEarly_0 & auto_out_0_d_bits_sink | muxStateEarly_1 & auto_out_1_d_bits_sink | muxStateEarly_2 & auto_out_2_d_bits_sink | muxStateEarly_7 & auto_out_7_d_bits_sink;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  wire [6:0]  out_27_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 7'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 7'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_source : 7'h0) | (muxStateEarly_3 ? auto_out_3_d_bits_source : 7'h0) | (muxStateEarly_4 ? auto_out_4_d_bits_source : 7'h0) | (muxStateEarly_5 ? auto_out_5_d_bits_source : 7'h0) | (muxStateEarly_6 ? auto_out_6_d_bits_source : 7'h0) | (muxStateEarly_7 ? auto_out_7_d_bits_source : 7'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  wire [1:0]  out_27_bits_param = (muxStateEarly_0 ? auto_out_0_d_bits_param : 2'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_param : 2'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_param : 2'h0) | (muxStateEarly_7 ? auto_out_7_d_bits_param : 2'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch)	// @[Arbiter.scala:90:24]
        beatsLeft <= (winnerQual_0 & auto_out_0_d_bits_opcode[0] ? ~(_beatsDO_decode_T_1[11:3]) : 9'h0) | {6'h0, (winnerQual_1 & auto_out_1_d_bits_opcode[0] ? ~(_beatsDO_decode_T_5[5:3]) : 3'h0) | (winnerQual_2 & auto_out_2_d_bits_opcode[0] ? ~(_beatsDO_decode_T_9[5:3]) : 3'h0) | (winnerQual_3 & auto_out_3_d_bits_opcode[0] ? ~(_beatsDO_decode_T_13[5:3]) : 3'h0) | (winnerQual_4 & auto_out_4_d_bits_opcode[0] ? ~(_beatsDO_decode_T_17[5:3]) : 3'h0) | (winnerQual_5 & auto_out_5_d_bits_opcode[0] ? ~(_beatsDO_decode_T_21[5:3]) : 3'h0) | (winnerQual_6 ? ~(_beatsDO_decode_T_25[5:3]) : 3'h0) | (winnerQual_7 & auto_out_7_d_bits_opcode[0] ? ~(_beatsDO_decode_T_29[5:3]) : 3'h0)};	// @[Arbiter.scala:88:30, :99:79, :112:73, :113:44, Bundles.scala:259:74, Edges.scala:106:36, :221:14, package.scala:235:{46,71,76}]
      else	// @[Arbiter.scala:90:24]
        beatsLeft <= beatsLeft - {8'h0, auto_in_d_ready & out_27_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, ReadyValidCancel.scala:49:33]
  ...
  assign auto_in_d_bits_data = (muxStateEarly_0 ? auto_out_0_d_bits_data : 64'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_data : 64'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_data : 64'h0) | (muxStateEarly_3 ? auto_out_3_d_bits_data : 64'h0) | (muxStateEarly_4 ? auto_out_4_d_bits_data : 64'h0) | (muxStateEarly_5 ? auto_out_5_d_bits_data : 64'h0) | (muxStateEarly_6 ? auto_out_6_d_bits_data : 64'h0) | (muxStateEarly_7 ? auto_out_7_d_bits_data : 64'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
