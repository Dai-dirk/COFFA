...
if [ ! -f ../chipyard/src/main/scala/config/COFFASoCConfigs.scala ]; then
    sed '1d; $d' $PWD/fgra-mg/src/main/scala/soc/FusionMemSoCConfig.scala > ../chipyard/src/main/scala/config/FusionMemSoCConfig.scala
fi
